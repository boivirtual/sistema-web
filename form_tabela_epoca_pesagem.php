...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Motivo de Pesagem</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_epoca_pesagem"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_epoca_pesagem;
                                    $descricao = $registro_tabela->tab_descricao_epoca_pesagem; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_epoca_pesagem; 
                                    ...
                                    if ($lixeira==1){
                                        ...
                                        if ($codigo<=5 || $codigo==8 || $codigo==11) {
                                            echo '<td></td>';
                                        }
                                        else {
                                            echo '<td>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Motivo de Pesagem - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_epoca_pesagem.php" enctype="multipart/form-data" id="gravar_epoca"
>
                                <div class="form-group col-md-12">
                                    <label for="codigo_epoca_pesagem" class="control-label"></label>
                                    <input name="codigo_epoca_pesagem" type="hidden" class="form-control" id="codigo_epoca_pesagem" 
                                    >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_epoca_pesagem" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_epoca_pesagem" type="text" class="form-control" id="descricao_epoca_pesagem" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Motivo de Pesagem - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_epoca_pesagem.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_epoca_pesagem" class="control-label">Código</label>
                                    <input name="codigo_epoca_pesagem" type="text" class="form-control" id="codigo_epoca_pesagem" 
                                    readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_epoca_pesagem" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_epoca_pesagem" type="text" class="form-control" id="descricao_epoca_pesagem" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Motivo de Pesagem - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_epoca_pesagem.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_epoca_pesagem" class="control-label">Código</label>
                                    <input name="codigo_epoca_pesagem" type="text" class="form-control" id="codigo_epoca_pesagem" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_epoca_pesagem" class="control-label">Descrição</label>
                                    <input name="descricao_epoca_pesagem" type="text" class="form-control" id="descricao_epoca_pesagem" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Motivo de Pesagem</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_epoca_pesagem.js';
  require 'rodape.php';
?>
