<?php
    ...
    $situacao_mov = $reg_mov->tbl_movimentacao_situacao;
	...
	header('Content-type: application/json');
	echo json_encode(array('success' => true, 'message' => 'Registro excluido com sucesso! ', 'id_pasto' => $id_pasto, 'descricao_pasto' => $descricao_pasto, 'descricao_lote' => $descricao_lote));
	mysqli_close($conector);
	exit;
