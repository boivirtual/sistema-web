        ...
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
            ...
            <section class="panel" style="overflow-x:auto; overflow-y:hidden;">
                <div class="row col-md-12 filtro_escondido"  id="total_contas">
                    ...
                    <div class="form-group col-md-10">
                        <p id="descricao_filtro" class="text-muted" 
                        style="color: #829c9c"><?php echo $descricao_filtro;?></p>
                    </div>
                    
                    <div class="form-group col-md-1">
                        <button type="button" class="form-control btn btn-success pull-right" onClick="lista_chuvas_excel()">Excel
                        </button>
                    </div>

                    <!--<div class="form-group col-md-1">
                        <button type="button" class="form-control btn btn-info pull-right exibir"
                        data-toggle="tooltip" data-placement="bottom" title="Maximizar tela filtros" onClick="voltar_filtro()"><i class="fa fa-sort-up"></i>&nbsp;<i class="fa fa-filter"></i>
                       </button>
                    </div>-->

                    <div class="form-group col-md-1 voltar">
                        <button type="button" class="form-control btn btn-info pull-right" onclick="voltar_filtro()">Voltar</button>
                    </div>
                </div>
