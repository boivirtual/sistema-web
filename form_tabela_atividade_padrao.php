...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
            ...
            <span class="titulo">Atividade Padrão</span></span>

           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Atividade Padrão</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            ...
                            <?php 
                                ...
                                $ssql = "select * from tbl_atividades_padrao"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tbl_atividade_padrao_id;
                                    $descricao = $registro_tabela->tbl_atividade_padrao_descricao; 
                                    $lixeira = $registro_tabela->tbl_atividade_padrao_lixeira; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Atividade Padrão - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_atividade_padrao.php" enctype="multipart/form-data" id="gravar_atividade">
                                <div class="form-group col-md-12">
                                    <label for="codigo_id" class="control-label"></label>
                                    <input name="codigo_id" type="hidden" class="form-control" id="codigo_id" 
                                    >
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Atividade Padrão - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_atividade_padrao.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="codigo_id" class="control-label">Código</label>
                                        <input name="codigo_id" type="text" class="form-control" id="codigo_id" 
                                        readonly="">
                                    </div>
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Atividade Padrão de Animais - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_atividade_padrao.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="codigo_id" class="control-label">Código</label>
                                        <input name="codigo_id" type="text" class="form-control" id="codigo_id" 
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="descricao" class="control-label"><span class="required">*</span> Descrição</label>
                                        <input name="descricao" type="text" class="form-control" id="descricao" readonly="">
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Atividade Padrão</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'atividade_padrao.js';
  require 'rodape.php';
?>
