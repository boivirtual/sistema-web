...
<body>
  ...
  <?php
   ...
   @ session_start();   
    ...
    if ($_SESSION['tipo_rel_ctr']==''){
        $tipo_rel = "A";
    }
    else {
        $tipo_rel =  $_SESSION['tipo_rel_ctr'];     
    }
		        ...
		        <div class="col-lg-12">
                    <div class="row col-md-12 filtro_exibido" id="consulta_contas">
                        <form method="GET" action="#" enctype="multipart/form-data" >
                            ...
                            <input type="hidden" name="tipo_conta" id="tipo_conta" value="C">
                                    ...
                                    <fieldset class="scheduler-border " >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-1">
                                                <button type="button" class="form-control btn btn-info pull-right" onclick="onclick=voltar_relatorios_receber()">Voltar
                                                </button>
                                            </div>
                                        </div>    
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="codigo_cliente" class="control-label">Cliente/Parceiro</label>
                                                <select class="form-control selectpicker" id="codigo_cliente" name="codigo_cliente" data-live-search="true" multiple style="z-index:5;" data-size="6">
                                        ...
                                        <div class="row">    
                                            ...
                                            <div class="form-group col-md-1">
                                                <button type="button" class="btn btn-primary pull-right" onclick="listar_contas_receber_tela(1)">Listar
                                                </button>
                                            </div>

                                            <div class="form-group col-md-1">
                                                <button type="button" class="form-control btn btn-success pull-right" onClick="listar_contas_receber_tela(2)">Excel
                                                </button>
                                            </div>
                                        </div>    
                                    </fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group col-md-3 pull-right">
                                        <a href="#" onclick="limpa_contas_selecionadas_ctr()">Limpar Filtros
                                        </a>
                                    </div>
                                </div>
                            </div>
