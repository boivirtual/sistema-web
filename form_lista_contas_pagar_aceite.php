<?php
    ...
    $order_venc = " ORDER BY cp.ctp_numero_doc ASC, cp.ctp_codigo_fazenda ASC, cp.ctp_parcela ASC";
    $order_emis = " ORDER BY cp.ctp_numero_doc ASC, cp.ctp_codigo_fazenda ASC, cp.ctp_parcela ASC";
?>
