    ...
    echo '<table class="table table-striped table-advance table-hover" id="tabela_nutricao" style="font-size: 12px">';
        ...
        echo '<tbody>';
            ...
            $sql = "SELECT * FROM tbl_nutricao
                ...
                WHERE tbl_nutricao_lixeira=0 " . $wlocal . $wperiodo . $wlote . $wpasto . $wproduto . 
            ...
            while ($reg_nut = mysqli_fetch_object($rs)){
                ...
                if ($encerrada=='S') {
                    ...
                    $consumo_cabeca = number_format($consumo_cabeca_dia, 2, ",", ".") .' g em ' . $dias_consumo . ' dia(s)';
                }
                else {
                    ...
                    $consumo_cabeca_dia = number_format($calculos[1], 2, ",", ".");
