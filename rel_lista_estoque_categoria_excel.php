...
$linha=5;
    ...
    for ($i=0; $i<($qtd_meses); $i++) { 
        ...
        if (($mes_hoje!=$mes_lista || $ano_hoje!=$ano_lista || $qtd_meses==1) && $total!=0) {
            ...
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(2, $linha, $qtd_femea['001']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(3, $linha, $qtd_femea['002']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(4, $linha, $qtd_femea['003']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(5, $linha, $qtd_femea['004']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(6, $linha, $qtd_femea['005']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(7, $linha, $qtd_macho['001']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(8, $linha, $qtd_macho['002']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(9, $linha, $qtd_macho['003']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(10, $linha, $qtd_macho['004']);
            $spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(11, $linha, $qtd_macho['005']);
...
header('Content-Disposition: attachment;filename="estoque_categoria_cabeca.xlsx"');
