...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
            ...
            <span class="titulo">Modalidade dos Produtos</span></span>

            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-map-o"></i> Modalidade dos Produtos</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="lista_modalidade_produto">
                    </div>
                ...
                <div class="modal-lg modal-dialog modal-dialog-centered" role="document" style="width: 100%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Modalidade dos Produtos - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_modalidade_produto.php" enctype="multipart/form-data" id="form_gravar_modalidade_produto">
                                    ...
                                    <div id="dados" class="tab-pane active">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <button type="button" class="btn btn-primary confirma_gravar" onClick="gravar_modalidade_produto()">Confirmar Inclusão</button>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Modalidade dos Produtos </h4>
                        </div>
            ...
            <div class="modal fade" id="mensagem_erro" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Modalidade dos Produtos - Erro</h4>
                        </div>
                        <div class="modal-body"></div>
                        <div class="modal-footer">
...
<?php
  $javascript_file_name = 'tabela_modalidade_produto.js';
  require 'rodape.php';
?>
