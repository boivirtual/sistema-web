    ...
    echo '<table class="table table-striped table-advance table-hover" id="tabela_movimentacao" style="font-size: 12px">';
            ...
            echo '<tbody>';
                ...
                while ($reg_mov = mysqli_fetch_object($rs)){
                    ...
                    $qtd_animais = $reg_mov->tbl_movimentacao_qtd_animais_pesados;
                    ...
                    if ($codigo_tipo==4) {
                       ...
                       // echo "<td width='8%'>".$codigo."</td>";
                        ...
                        if ($aceite_financeiro==''){
                            ...
                            echo "<a class='btn tooltips' href='form_movimentacao_animais_consultar_individual.php?id=".$codigo."'><i class='icon_search' data-toggle='tooltip' data-placement='left' title='Consultar esse registro' o></i></a>"; 
                            ...
                            if ($anomes_mov>=$anomes_sistema) {
                                echo "<a class='btn' href='#'>
                                    <i class='icon_trash_alt' data-toggle='tooltip' data-placement='left'  title='Estornar esse registro' onClick='excluir_movimentacao(\"{$codigo}\")'>
                                            </i></a>";
                            }
                        ...
                        foreach ($array_locais_usuario as $value) {
                            ...
                            if ($value==$codigo_origem) {
                                ...
                                if ($lixeira==1) {
                                   // echo "<td width='8%' style='color:#ccc'>".$codigo."</td>";
                                    ...
                                    //echo "<td width='8%' class='situacao_nao'>".$codigo."</td>";
                                    ...
                                    //if ($codigo_pesagem==0 && $codigo_pesagem=='') {
                                    //    echo "<a class='btn tooltips' href='form_movimentacao_animais_editar.php?id=".$codigo."'><i class='icon_pencil' data-toggle='tooltip' data-placement='left' title='Editar esse registro' o></i></a>"; 
                                    //}
                                    //else {
                                        echo "<a class='btn' href='form_movimentacao_animais_consultar_individual.php?id=".$codigo."'><i class='icon_search' data-toggle='tooltip' data-placement='left' title='Consultar esse registro' ></i></a>"; 
                                    //}
