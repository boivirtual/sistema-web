...
<div class="row" >
<table id="tabela_analise_previsto_realizado" class="table table-advance table-hover table-borderless" style="font-size:11px;" width="100%;">
                ...
                if ($tipo_rel==1){
                    ...
                    foreach ($tem_valor as $key_tem_valor => $value_tem_valor) {
                        if ($value_tem_valor == "S"){
                            ...
                            echo '<tr>';
/*if (1) {
   style="background-color: #d8e4bc;" 
   style="background-color: #ebfbde;"
}
else {
    if (2 || 3)
...
if (substr($codigo_conta, 0,1==1) {
    echo '<td width="3%" align="right" style="background-color: #ebfbde;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
    echo '<td width="3%" align="right" style="background-color: #ebfbde;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
}
else if (substr($codigo_conta, 0,1==2 || substr($codigo_conta, 0,1==3) {
    echo '<td width="3%" align="right" style="background-color: #f2dcdb;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
    echo '<td width="3%" align="right" style="background-color: #f2dcdb;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
}
    ...
    echo '<td width="3%" align="right" style="background-color:  #f2dcdb;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                            ...
                            if (substr($codigo_conta, 1,6)==0){
                                if (substr($codigo_conta, 0,1)==1) {
                                    echo '<td width="22%" style="background-color: #d8e4bc; color: #000000;">'.$descricao_conta[$codigo_conta].'</td>';
                                }
                                else if (substr($codigo_conta, 0,1)==2 || substr($codigo_conta, 0,1)==3) {
                                    echo '<td width="22%" style="background-color: #e6b8b7; color: #000000;">'.$descricao_conta[$codigo_conta].'</td>';
                                }
                                else if (substr($codigo_conta, 0,1)==4 || substr($codigo_conta, 0,1)==5) {
                                    echo '<td width="22%" style="background-color: #da9694; color: #000000;">'.$descricao_conta[$codigo_conta].'</td>';
                                }
                            }
                            else if (substr($codigo_conta, 3,4)==0){
                                if (substr($codigo_conta, 0,1)==1) {
                                    echo '<td width="22%" style="background-color: #ebfbde; color: #000000;">'.$descricao_conta[$codigo_conta].'</td>';
                                }
                                else if (substr($codigo_conta, 0,1)==2 || substr($codigo_conta, 0,1)==3) {
                                    echo '<td width="22%" style="background-color: #f2dcdb; color: #000000;">'.$descricao_conta[$codigo_conta].'</td>';
                                }
                                else if (substr($codigo_conta, 0,1)==4 || substr($codigo_conta, 0,1)==5) {
                                    echo '<td width="22%" style="background-color: #f2dcdb; color: #000000;">'.$descricao_conta[$codigo_conta].'</td>';
                                }
                            ...
                            for ($i=1; $i <= 13 ; $i++) { 
                                if (substr($codigo_conta, 1,6)==0){
                                    if (substr($codigo_conta, 0,1)==1) {
                                        echo '<td width="3%" align="right" style="background-color: #d8e4bc; color: #000000;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                        echo '<td width="3%" align="right" style="background-color: #d8e4bc; color: #000000;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                    }
                                    else if (substr($codigo_conta, 0,1)==2 || substr($codigo_conta, 0,1)==3) {
                                        echo '<td width="3%" align="right" style="background-color: #e6b8b7; color: #000000;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                        echo '<td width="3%" align="right" style="background-color: #e6b8b7; color: #000000;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                    }
                                    else if (substr($codigo_conta, 0,1)==4 || substr($codigo_conta, 0,1)==5) {
                                        echo '<td width="3%" align="right" style="background-color:  #da9694; color: #000000;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                        echo '<td width="3%" align="right" style="background-color:  #da9694; color: #000000;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                    }
                                }
                                else if (substr($codigo_conta, 3,4)==0){
                                    if (substr($codigo_conta, 0,1)==1) {
                                        echo '<td width="3%" align="right" style="background-color: #ebfbde; color: #000000;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                        echo '<td width="3%" align="right" style="background-color: #ebfbde; color: #000000;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                    }
                                    else if (substr($codigo_conta, 0,1)==2 || substr($codigo_conta, 0,1)==3) {
                                        echo '<td width="3%" align="right" style="background-color: #f2dcdb; color: #000000;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                        echo '<td width="3%" align="right" style="background-color: #f2dcdb; color: #000000;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                    }
                                    else if (substr($codigo_conta, 0,1)==4 || substr($codigo_conta, 0,1)==5) {
                                        echo '<td width="3%" align="right" style="background-color:  #f2dcdb; color: #000000;">'.number_format($total_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                                        echo '<td width="3%" align="right" style="background-color:  #f2dcdb; color: #000000;">'.number_format($total_nao_realizado[$codigo_conta ][$i],2,',','.').'</td>';
                ...
                } // fim do if $tipo_rel==1 Fim Realizado / Nao Realizado
                ...
                // Inicio do else para Realizado
                    ...
                    foreach ($tem_valor as $key_tem_valor => $value_tem_valor) {
                        if ($value_tem_valor == "S"){
                            ...
                            /*if (substr($codigo_conta, 1,6)==0){
                                echo '<td width="18%" style="background-color: #C2E0E0; color: #1C1C1C">'.$descricao_conta[$codigo_conta].'</td>';
                            }
                            else if (substr($codigo_conta, 3,4)==0){
                                echo '<td width="18%" style="background-color: #DEE; color: #696969">'.$descricao_conta[$codigo_conta].'</td>';
                            }
                            else {
                                echo '<td width="18%">'.$descricao_conta[$codigo_conta].'</td>';
                            }*/
...
<?php
    ...
    if ($tipo_rel==1) {
        echo '<tr>';
        echo '<th style="width:18%;" rowspan="2">Descrição da Conta&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>';

        for ($i=1; $i <= 12 ; $i++) { 
            echo '<th style="width:6%;" colspan="2" class="text-center">'.$array_mes[$i].'</th>';
        }
        echo '<th style="width:10%;" colspan="2" class="text-center">Total</th>';
        echo'</tr>';

        echo '<tr>';
        for ($i=1; $i <=12 ; $i++) {
            echo '<th width="3%" class="text-right">Realizado</th>';
            echo '<th width="3% "class="text-right" style="color: #a6a6a6; ">Previsto</th>';
        }

        echo '<th width="5%" class="text-right">Realizado</th>';
        echo '<th width="5% "class="text-right"  style="color: #a6a6a6;">Previsto</th>';
        echo '</tr>';
    
        echo '<tr>';
        echo '<th class="text-right" style="width:18%; font-weight: bold">SALDO ANTERIOR</th>';
        for ($i=1; $i <= 12 ; $i++) { 
            if ($saldo_anterior_mes[$i]<0){
                echo '<th width="3%" style="font-weight: bold; color: #8B0000; text-align: right;">'.number_format($saldo_anterior_mes[$i],2,',','.').'</th>';
            }
            else if ($saldo_anterior_mes[$i]>0){
                echo '<th width="3%" style="font-weight: bold; color: #006400; text-align: right;">'.number_format($saldo_anterior_mes[$i],2,',','.').'</th>';
            }
            else {
                echo '<th width="3%" style="font-weight: bold; text-align: right;">'.number_format($saldo_anterior_mes[$i],2,',','.').'</th>';
            }

            if ($saldo_anterior_mes_nao[$i]<0){
                echo '<th width="3%" style="font-weight: bold; color: #ff8f8f; text-align: right;">'.number_format($saldo_anterior_mes_nao[$i],2,',','.').'</th>';
            }
            else if ($saldo_anterior_mes_nao[$i]>0){
                echo '<th width="3%" style="font-weight: bold; color: #7db87d; text-align: right;">'.number_format($saldo_anterior_mes_nao[$i],2,',','.').'</th>';
            }
            else { 
                echo '<th width="3%" style="font-weight: bold; text-align: right;">'.number_format($saldo_anterior_mes_nao[$i],2,',','.').'</th>';
            }
        }
        ...
        echo '<tr>';
        echo '<th class="text-right" style="width:18%;font-weight: bold">SALDO DO MÊS</th>';
        for ($i=1; $i <= 12 ; $i++) { 
            if ($saldo_mes[$i]<0){
                echo '<th width="3%" style="font-weight: bold; color: #8B0000; text-align: right;">'.number_format($saldo_mes[$i],2,',','.').'</th>';
            }
            else if ($saldo_mes[$i]>0){
                echo '<th width="3%" style="font-weight: bold; color: #006400; text-align: right;">'.number_format($saldo_mes[$i],2,',','.').'</th>';
            }
            else {
                echo '<th width="3%" style="font-weight: bold; text-align: right;">'.number_format($saldo_mes[$i],2,',','.').'</th>';
            }

            if ($saldo_mes_nao[$i]<0){
                echo '<th width="3%" style="font-weight: bold; color: #ff8f8f; text-align: right;">'.number_format($saldo_mes_nao[$i],2,',','.').'</th>';
            }
            else if ($saldo_mes_nao[$i]>0){
                echo '<th width="3%" style="font-weight: bold; color: #7db87d; text-align: right;">'.number_format($saldo_mes_nao[$i],2,',','.').'</th>';
            }
            else {
                echo '<th width="3%" style="font-weight: bold; text-align: right;">'.number_format($saldo_mes_nao[$i],2,',','.').'</th>';
            }
        }
        ...
        echo '<tr>';
        echo '<th class="text-right" style="width:18%; font-weight: bold">SALDO FINAL</th>';
        for ($i=1; $i <= 12 ; $i++) { 
            if ($saldo_final_mes[$i]<0){
                echo '<th width="3%" style="font-weight: bold; color: #8B0000; text-align: right;">'.number_format($saldo_final_mes[$i],2,',','.').'</th>';
            }
            else if ($saldo_final_mes[$i]>0){
                echo '<th width="3%" style="font-weight: bold; color: #006400; text-align: right;">'.number_format($saldo_final_mes[$i],2,',','.').'</th>';
            }
            else {
                echo '<th width="3%" style="font-weight: bold; text-align: right;">'.number_format($saldo_final_mes[$i],2,',','.').'</th>';
            }

            if ($saldo_final_mes_nao[$i]<0){
                echo '<th width="3%" style="font-weight: bold; color: #ff8f8f; text-align: right;">'.number_format($saldo_final_mes_nao[$i],2,',','.').'</th>';
            }
            else if ($saldo_final_mes_nao[$i]>0){
                echo '<th width="3%" style="font-weight: bold; color: #7db87d; text-align: right;">'.number_format($saldo_final_mes_nao[$i],2,',','.').'</th>';
            }
            else {
                echo '<th width="3%" style="font-weight: bold; text-align: right;">'.number_format($saldo_final_mes_nao[$i],2,',','.').'</th>';
            }
        }
        echo '<th width="5%"></th>';
        echo '<th width="5%"></th>';
        ...
        for ($i=1; $i <=13 ; $i++) {
            echo '<th width="3%" class="text-right">Previsto</th>';
        }
        echo '</tr>';
...
<!--                                    <hr align="center"> 
    ...
    <script>
        $(document).ready(function() {
            var table = $('#tabela_analise_previsto_realizado').DataTable( {
                fixedColumns:   {
                    //leftColumns: 1,
                    //rightColumns: 0,
                    heightMatch: 'none',
