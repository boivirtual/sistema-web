...
<head>
  ...
  <!-- Bootstrap CSS -->
    ...
    <style type="text/css">
        ...
        /* Garante que o modal de confirmação fique na frente de outros modais */
        #modal_confirma_exclusao {
            z-index: 1060 !important; /* Valor maior que o padrão 1050 do Bootstrap */
        }
    </style>
</head>
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                            ...
                            <div class="tab-panel">
                                <div class="tab-pane active">
                                    <fieldset class="scheduler-border" id="dados_consulta">
                                        ...
                                        <div class="row filtros_consulta" hidden>
                                            <div class="col-md-12">
                                                <a href="#" style="font-size: 0.9em; font-weight: 500; text-align: right; color: #128cb8; float: right;" onclick="mais_relatorios()" data-toggle="tooltip" data-placement="top" title="Histórico de Animais" class="pull-right"><i class="fa fa-plus"></i> Relatórios</a>
                                            </div>
                                        </div> 
                                    </fieldset>
            ...
            <div class="modal fade" id="modal_confirma_exclusao" tabindex="-1" role="dialog" aria-labelledby="modal_incluirCenterTitle myLargeModalLabel" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title">Confirma excluir este registro?</h3>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <p style="font-weight: bold;">Se voce confirmar a exclusão com a sua senha, será excluido toda a pesagem e não será possivel recuperar.</p>
                                </div>
                            </div>

                            <p class=" text-center" id="texto_confirmacao_exclusao"></p>

                            <div class="row text-center">
                                <div class="form-group col-md-4"></div>

                                <div class="form-group col-md-4">
                                    <input type="password" id="senha_exclusao" class="form-control" 
                                           placeholder="Digite sua senha" autocomplete="off">
                                    <small id="erro_senha" class="text-danger" style="display:none;">Senha incorreta!</small>
                                </div>
                            </div>
                        </div>
                        
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btn_confirmar_exclusao_modal">Confirmar</button>
                ...
                <div class="modal-lg modal-dialog modal-dialog-centered" role="document"style="width: 100%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" id="modal_incluirLabel">Pesagens em Andamento ou Não Finalizadas</h3>
                        </div>
                        ...
                        <div class="modal-footer">
                            <a href="#" style="font-size: 1.3em; font-weight: 300; line-height: 35px;" 
                                onclick="gerar_excel_pesagem_sem_finalizar()" 
                                data-toggle="tooltip" 
                                data-placement="top" 
                                title="Compara Pesagens com o Gado Todo" class="pull-left">
                                <i class="fa fa-file-excel-o"></i> Verificação de Animais Pesados/Não Pesados
                            </a>
...
<script>
    var senhaUsuarioLogado = "<?php echo $_SESSION['senha_usuario']; ?>";
</script>
