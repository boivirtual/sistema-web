...
<body>
  ...
  <?php
   ...
   @ session_start();   
    ...
    $local = $_SESSION['local_pesagem_rel'];
    $array_categoria = $_SESSION['array_categoria_pesagem_rel'];
                                        ...
                                        <fieldset class="scheduler-border " >
                                            ...
                                            <div class="row ">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input id="exibe_categorias_rel" type="hidden" <?php echo "value='".$array_categoria."'"; ?>>

                                                    <input id="exibe_local_rel" type="hidden" <?php echo "value='".$local."'"; ?>>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3 local">
                                                    <label for="codigo_fazenda" class="control-label"><span class="required">*</span> Fazenda</label>
                                                ...
                                                <div class="form-group col-md-1">
                                                    ...
                                                    <button type="button" class="form-control btn btn-primary pull-right" onclick="listar_historico_pesagem_lote()">Listar
                                                    </button>
                                                </div>
                                            </div>
                                        </fieldset>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Relatório Histórico de Pesagem - Mensagem</h4>
                        </div>
