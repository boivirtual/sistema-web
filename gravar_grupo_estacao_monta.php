...
if (!isset($_POST['codigo_grupo'])) {
	// Para os programas form_cobertura_animais.php e 
	//                   form_cobertura_animais_diagnostico
	$codigo_grupo= $_POST['codigo_novo_grupo'];
	$descricao_grupo = $_POST['descricao_novo_grupo'];
	$codigo_estacao_monta = $_POST['codigo_estacao_novo_grupo'];
	$codigo_local = $_POST['codigo_local_novo_grupo'];
	$tipo_gravacao = $_POST['tipo_gravacao_novo_grupo'];
}
else {
	// Para o programa form_selecao_matrizes_incluir.php
