...
<div class="row" >
<table id="compra_venda" class="table table-advance table-hover table-borderless" style="font-size:11px;" width="100%">
...
<!--                                    <hr align="center"> 
    ...
    <script>
        $(document).ready(function() {
            var table = $('#compra_venda').DataTable( {
                dom: '<"header-toolbar"if>rt',
                scrollY:  "180px",
                scrollX:  true,
                paging:   false,
                search:   true,
