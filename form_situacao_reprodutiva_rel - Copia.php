                                        ...
                                        <div id="dados" class="tab-pane active">
                                            ...
                                            <div class="row" style="padding-top: 10px;">
                                                <div class="col-md-8">
                                                    ...
                                                    if ($tipo_rel=='I') :
                                                    ?>
                                                    <label class="label_consulta_rel_rel">Fazenda:</label>
...
?>
    <div class="row">
        ...
        ?>
        <div class="col-md-4">
            <h4 class="page-header-animais">
                Fêmea: <?php echo $codigo_consulta . $mensagem;?></h4>
        </div>
        ...
        <div class="col-md-4">
            <h3 class="page-header-animais">
                Fêmea: <?php echo $codigo_consulta . ' - ' . $situacao;?>
            </h3>
        </div>

        <div class="col-md-2" style="margin-bottom: 10px; font-size: 16px; ">
            <label class="page-header-animais"> Animal Ativo:</label>
            <?php
            if ($ativo == 'Sim') :
            ?>
        ...
        ?>
            <div class="col-md-4"style="font-size: 16px; ">
                <label class="page-header-animais"> Situação:</label>
    ...
    <div class="row">
        ...
        <?php
            if ($descarte == 'S') :
        ?>
            <div class="col-md-8" style="font-size: 16px; margin-bottom: 10px;">
                <label class=""> Descartado para reprodução:</label>
...
<?php
/*    $sql = "SELECT * from tbl_animais 
        WHERE tbl_animal_codigo_id=1901"; 
*/
    ...
    if ($num_rows_animais!=0){
        while ($reg_animal = mysqli_fetch_object($rs)){
            ...
            if ($wcategoria=="" && 
                ...
                (($solteiras==$vaca_solteira && ($previsao_parto_edi=='' || 
                 ($nascido=='N' || $nascido=='A' || 
                 $nascido=='M' || $nascido=='O'))) || 
                 ($paridas==$vaca_parida && 
