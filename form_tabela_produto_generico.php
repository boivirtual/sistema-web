...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
            ...
            <span class="titulo">Descrição Padrão de Produtos</span></span>

            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-map-o"></i> Descrição Padrão de Produtos</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="modal-lg modal-dialog modal-dialog-centered" role="document" style="width: 100%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Descrição Padrão de Produtos - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_produto_generico.php" enctype="multipart/form-data" id="form_gravar_produto_generico">
                                    ...
                                    <div id="dados" class="tab-pane active">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" name="modalidade" id="modalidade">
                                                    <?php
                                                        ...
                                                        while ($reg_modalidade = mysqli_fetch_object($rs_modalidade)){
                                                            echo '<option value="'.$reg_modalidade->tbl_codigo_modalidade.'">'.$reg_modalidade->tbl_descricao_modalidade.'</option>';
                                                        }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <button type="button" class="btn btn-primary confirma_gravar" onClick="gravar_produto_generico()">Confirmar Inclusão</button>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Descrição Padrão de Produtos </h4>
                        </div>
            ...
            <div class="modal fade" id="mensagem_erro" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Descrição Padrão de Produtos - Erro</h4>
                        </div>
                        <div class="modal-body"></div>
                        <div class="modal-footer">
...
<?php
  $javascript_file_name = 'tabela_produto_generico.js';
  require 'rodape.php';
?>
