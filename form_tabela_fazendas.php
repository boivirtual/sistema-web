...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-tractor"></i> Fazendas</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_fazendas"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_fazenda = mysqli_fetch_object($rs)){
                                    $codigo = $registro_fazenda->fazenda_codigo;
                                    $nome = $registro_fazenda->fazenda_nome; 
                                    $area_total = $registro_fazenda->fazenda_area_total; 
                                    $area_total_construida = $registro_fazenda->fazenda_area_construida; 
                                    $lixeira = $registro_fazenda->fazenda_registro_lixeira; 
                                    ...
                                    if ($lixeira==1){
                                        ...
                                        echo '<td>
                                              ...
                                              data-whateverareatotal="'.$area_total.'"
                                              data-whateverareatotalconstruida="'.$area_total_construida.'"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Fazendas - Incluir</h4>
                        </div>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="gravar_fazendas.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="nome_fazenda" class="control-label"><span class="required">*</span>Nome</label>
                                    <input name="nome_fazenda" type="text" class="form-control" id="nome_fazenda" required="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="area_total" class="control-label">Área Total (ha)</label>
                                    <input name="area_total" type="number" step="any" class="form-control" id="area_total"> 
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="area_total_construida" class="control-label">Área Total Construida (ha)</label>
                                    <input name="area_total_construida" type="number" step="any" class="form-control" id="area_total_construida"> 
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Fazendas - Editar</h4>
                        </div>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="gravar_fazendas.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="nome_fazenda" class="control-label"><span class="required">*</span>Nome</label>
                                    <input name="nome_fazenda" type="text" class="form-control" id="nome_fazenda" required="" onkeyup="destrava_alteracao()">
                                </div>

                                <div class="form-group col-md-12 col-sm-12">
                                    <label for="area_total" class="control-label">Área Total (ha)</label>
                                    <input name="area_total" type="number" step="any" class="form-control" id="area_total" onkeyup="destrava_alteracao()">
                                </div>

                                <div class="form-group col-md-12 col-sm-12">
                                    <label for="area_total_construida" class="control-label">Área Total Construída (ha)</label>
                                    <input name="area_total_construida" type="number" step="any" class="form-control" id="area_total_construida" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Fazendas - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_fazendas.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_fazenda" class="control-label">Código</label>
                                    <input name="codigo_fazenda" type="text" class="form-control" id="codigo_fazenda" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="nome_fazenda" class="control-label">Nome</label>
                                    <input name="nome_fazenda" type="text" class="form-control" id="nome_fazenda" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Fazendas</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_fazendas.js';
  require 'rodape.php';
?>
