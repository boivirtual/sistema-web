            ...
            while ($reg_animais = mysqli_fetch_object($tbl_animais)) {
                ...
                if ($codigo_categoria_novo!=$categoria_pasto) {
                    ...
                    if ($num_rows_media!=0){
                        ...
                        if (!$resultado){
                          echo 'Erro ao atualizar a categoria velha' . $erro_mysql . '</br>';
                        } 
                    }
                    ...
                    if (!$resultado){
                      echo 'Erro ao gravar nova categoria' . $erro_mysql . '</br>';
                    } 
                    ...
                    if (!$resultado){
                      echo 'Erro ao gravar atualizar animais no pasto' . $erro_mysql . '</br>';
                    } 
                }
