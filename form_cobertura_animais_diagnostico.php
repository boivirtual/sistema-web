...
<head>
  ...
  <style type="text/css">
    ...
    .bootstrap-select .bs-actionsbox {
        text-align: right; 
        padding: 5px 25px 5px 0px; /* Ajusta o padding para melhor visualização */
    }
...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
                                    ...
                                    <fieldset class="scheduler-border" id="dados_consulta">  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2 nascido">
                                                ...
                                                <select class="form-control selectpicker" multiple id="situacao_monta_servidas" name="situacao_monta_servidas" >
            ...
            <div class="modal fade" id="modalReplicarData" tabindex="-1" role="dialog" aria-labelledby="modalReplicarDataLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="modalReplicarDataLabel">Indicar Diagnóstico</h4>
                        </div>

                        <div class="modal-body">
                            <p id="textoModalReplicar">Deseja replicar esta data para todas as outras linhas vazias?</p>
                            
                            <!--<div id="containerNaoPerguntar" style="display: none; margin-top: 10px;">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label style="font-weight: normal; cursor: pointer;">
                                            <input type="checkbox" id="chkNaoPerguntar"> 
                                            <strong>Não fazer mais essa pergunta</strong>
                                        </label>
                                    </div>
                                </div>
                            </div>-->
                        ...
                        <div class="modal-footer">
                            ...
                            <label style="font-weight: normal; cursor: pointer; float: left;">
                            <input type="checkbox" id="chkNaoPerguntar"> 
                            Não fazer mais essa pergunta
                            </label>


                            <button type="button" class="btn btn-default" id="btnNaoReplicar">Não</button>
                            <button type="button" class="btn btn-primary" id="btnConfirmarReplica">Sim, replicar</button>
            ...
            <div class="modal" id="modal_diagnostico_negativo" tabindex="-1" role="dialog" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <p>Ao confirmar, essa fêmea estará liberada para nova reprodução.</p>

                                            <!--<p style='font-weight: bold;'> Quanto ao diagnóstico negativo do animal, selecine uma opção</p>-->
                                        </div>
                                    </div>

                                    <!--<div class="row">
                                        <div class="form-group col-md-6 grupo_nova_cobertura">
                                            <select class="form-control" name="grupo_nova_cobertura" id="grupo_nova_cobertura">
                                                <option value="000">Incluir em um Grupo</option>
                                                </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4  grupo_monta">
                                            <p class="grupos_estacao"  
                                                onclick="modal_novo_grupo_estacao()" style="color: #1E90FF; cursor: pointer; font-size: 13px;">
                                                    <i class="fa fa-edit"></i>
                                                    &nbsp;Incluir/Editar Grupo
                                            </p>
                                        </div>

                                        <div class="label_nova_cobertura" hidden>
                                            <label class="radio-inline">
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-success" type="button" onclick="gravar_diagnostico_negativo_confirmacao();">Confirma</button>
            ...
            <div class="modal" id="modal_novo_grupo_estacao" tabindex="-1" role="dialog" 
             aria-labelledby="modal_incluirCenterTitle" aria-hidden="true"  data-backdrop="static">
                ...
                <div class="modal-lg modal-dialog modal-dialog-centered modal-lg" role="document" style="width: 100%;">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="modal_incluirLabel">Grupos </h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="#" enctype="multipart/form-data" id="form_grupo_novo_estacao">
                                <div class="tab-content">
                                    <div class="alert alert-danger alert_erro_grupo" hidden="true">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2">
                                                <button class="btn btn-info pull-right btn-voltar-grupos" type="button">Voltar</button>
                                            </div>
                                        </div>

                                        <div class="row">  
                                            <div class="form-group col-md-3">
                                                <a class='btn' href='#' id='btnAdicionar_grupo' style="font-size: 16px">
                                            ...
                                            <div class="form-group col-md-2 novo_grupo" hidden="">
                                                ...
                                                <input name="codigo_novo_grupo" type="number" class="form-control" id="codigo_novo_grupo">
                                            </div>

                                            <div class="form-group col-md-3 novo_grupo" hidden="">
                                                <label class="control-label"><span class="required">*</span> Descrição</label> 
                                                <input name="descricao_novo_grupo" type="text" class="form-control" id="descricao_novo_grupo" maxlength="30" onkeyup="maiuscula(this)" onkeypress="return desabilita_enter(this, event)">
                                            </div>

                                            <div class="form-group col-md-2 novo_grupo" hidden="">
                                                <label class="control-label">&nbsp;</label> 
                                                <button type="button" class="form-control btn-success gravar_novo_grupo" onClick="gravar_novo_grupo()">Gravar</button>

                                                <input type="hidden" name="codigo_estacao_novo_grupo" id="codigo_estacao_novo_grupo">

                                                <input type="hidden" name="codigo_local_novo_grupo" id="codigo_local_novo_grupo">

                                                <input type="hidden" name="proximo_grupo" id="proximo_grupo">

                                                <input type="hidden" name="tipo_gravacao_novo_grupo" id="tipo_gravacao_novo_grupo" value="0">
                                            </div>
                                        </div>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-info pull-right btn-voltar-grupos" type="button">Voltar
                            </button>
                        </div>
            ...
            <div class="modal fade" id="mensagem_retorno_novo_grupo" tabindex="-1" role="dialog" 
                aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Cobertura - Grupos</h4>
                        </div>
                        <div class="modal-body"></div>
                        <div class="modal-footer">
                        <button data-dismiss="modal" class="btn btn-default" type="button" onclick="modal_novo_grupo_estacao();">Fechar</button>
                        </div>
                    </div>
                </div>
            </div>
