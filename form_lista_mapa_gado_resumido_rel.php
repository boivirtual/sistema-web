...
<table class="table table-bordered table-striped table-advance table-hover" id="tabela_itens_consulta" width="80%" style="font-size: 12px;">
        ...
        while ($reg_pasto = mysqli_fetch_object($tbl_pasto)) {
            ...
            if ($num_rows_animal!=0) {
                ...
                if ($total_animais_pasto!=0) {
                    ...
                    echo '<td width="8%" class="text-center">'.$dias_pasto.'</td>';
...
<thead>
    ...
    <tr>
        ...
        <th style="text-align: center;">Macho</th>
        <th style="text-align: center;">Fêmea</th>
    </tr>
</thead>
