                                    ...
                                    <fieldset class="scheduler-border" id="dados_consulta">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <!--<button type="button" class="form-control btn btn-default pull-right" style="color: #128cb8; border: #128cb8;" data-toggle='tooltip' data-placement='top' title="Verificar aqui o que escrever" onclick="relatorio_consumo_nutricao()">Relatório</button>-->
                                            </div>
...
<script src="js/nutricao_velho.js?<?php echo Versao; ?>" charset="utf-8" type="text/javascript" ></script>
