                                        ...
                                        <div id="dados" class="tab-pane active">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input class="form-control" type="text" name="lote" id="lote" onkeyup="maiuscula(this)"
                                                    <?php echo "value='".$lote."'";?>>
                                                </div>
...
if ($peso==0) {
    ...
    echo '<td width="8%" class="peso"><input class="form-control input-sm peso" name="peso" type="number" onkeypress = "return numeros(this, event)"></td>';
    ...
    echo '<td width="15% "class="obs"><input class="form-control input-sm obs" name="obs" type="text" onkeypress = "return desabilita_enter (this, event)" onkeyup="maiuscula(this)"></td>';
    echo '</tr>';
}
else {
    echo '<tr>';
    ...
    echo '<td width="18%">'.$desc_pasto.'</td>';
    echo '<td width="20%" class="grupo"><input class="form-control input-sm grupo" name="grupo" type="number" onkeypress = "return numeros(this, event)" value="'.$grupo.'"></td>';
            ...
            <div class="modal fade" id="modal_finalizar" tabindex="-1" role="dialog" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button data-dismiss="modal" class="btn btn-success" type="button" onclick="gravar_finalizar_pesagem();">Sim</button>
