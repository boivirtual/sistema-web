...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Grupo de Produtos</h3>
                   <!-- <ol class="breadcrumb">
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_grupo_produtos"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_grupo_produtos;
                                    $descricao = $registro_tabela->tab_descricao_grupo_produtos; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_grupo_produtos; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Grupo de Produtos - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_grupo_produtos.php" enctype="multipart/form-data" id="gravar_grupo">
                                <div class="form-group col-md-12">
                                    <label for="codigo_grupo_produtos" class="control-label"></label>
                                    <input name="codigo_grupo_produtos" type="hidden" class="form-control" id="codigo_grupo_produtos" 
                                    >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_grupo_produtos" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_grupo_produtos" type="text" class="form-control" id="descricao_grupo_produtos" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Grupo de Produtos - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_grupo_produtos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_grupo_produtos" class="control-label">Código</label>
                                    <input name="codigo_grupo_produtos" type="text" class="form-control" id="codigo_grupo_produtos" 
                                    readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_grupo_produtos" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_grupo_produtos" type="text" class="form-control" id="descricao_grupo_produtos" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Grupo de Produtos - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_grupo_produtos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_grupo_produtos" class="control-label">Código</label>
                                    <input name="codigo_grupo_produtos" type="text" class="form-control" id="codigo_grupo_produtos" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_grupo_produtos" class="control-label">Descrição</label>
                                    <input name="descricao_grupo_produtos" type="text" class="form-control" id="descricao_grupo_produtos" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Grupo de Produtos</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_grupo_produtos.js';
  require 'rodape.php';
?>
