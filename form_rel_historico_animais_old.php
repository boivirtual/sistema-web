                                        ...
                                        <fieldset class="scheduler-border " >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3 codigo" hidden>
                                                    <label for="codigo_numerico_filtro" class="control-label"><span class="required">*</span> Código do Animal</label>
                                                ...
                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-primary pull-right" data-toggle='tooltip' data-placement='top' title="Listar na Tela" onclick="listar_historico_animais(1)">Listar
                                                    </button>
                                                </div>

                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-success pull-right" onClick="listar_historico_animais(2)">Excel
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane active">
                                        <div class="row">  
                                            <div class="form-group col-xs-12 col-md-12">
                                                <button type="button" class="btn btn-primary" onclick="listar_historico_animais(4)">Aplicar Filtros</button>
                                        ...
                                        <div class="row ">
                                            <div class="form-group col-md-4">
                                                ...
                                                ?>
                                                <!--    <option value="9999999999">Outros Locais (Animais Vendidos)</option>-->
                                                </select>
                                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Relatório Listagem de Animais - Mensagem</h4>
                        </div>
...
<script>
    $(document).ready(function(){
        $('#codigo_numerico_filtro').typeahead({
