...
<?php
            ...
            if ($filtro_negativas=='S' && $filtro_positivas=='S') {
                if ($filtro_vacas_paridas=='N' && $filtro_vacas_solteiras=='N' && 
                    ...
                    if ($animal['filtroNumPartos']=='S' && 
                        ...
                        $animais_listados++;
                        $numero_item = listar($conector, $animal);  
                    }
                }
    ...
    function listar($conector, $animal) {
        ...
        echo '<td width="5%">'.$nascimento_edi.'</td>';
        ...
        echo '<td width="3%" style="color: red; text-align: center;">'.$descarte.'</td>';    
        echo '</tr>';
    }
