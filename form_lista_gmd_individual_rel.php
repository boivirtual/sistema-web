<?php
    function listar($conector, $animal, $array_mes_ano, $array_peso, $data_inicial, $data_final, $qtd_meses, $array_mes, $array_ano, $ano_mes, $gmd_total, $numero_gmd, $dados_pesos_do_animal, $animais_listados) {
        ...
        $descricao_raca = $animal['descricaoRaca'];
        $descricao_pelagem = $animal['descricaoPelagem'];
        $descricao_mae = $animal['codigoMaeAlfaNumerico'];
        $descricao_pai = $animal['codigoPaiAlfaNumerico'];
        ...
        if (!empty($dados_pesos_do_animal)) {
            ...
            if ($ganho!=0) {
                ...
                if ($ativo=='N') {
                    if ($situacao=='V') {
                        echo '<td width="7%" style="color: blue;">'.$codigo_edi.'</td>';
                        echo '<td>'.$animal_descarte.'</td>';
                        echo '<td width="26%" style="color: blue;">'.$desc_local.'</td>';    
                        echo '<td width="3%" style="color: blue; text-align: center;">'.$sexo.'</td>';   
                        echo '<td width="5%" style="color: blue; text-align: center;">'.$data_nasc_edi.'</td>';
                        echo '<td width="12%" style="color: blue;">'.$descricao_raca.'</td>';    
                        echo '<td width="5%" style="color: blue;">'.$descricao_mae.'</td>';    
                        echo '<td width="5%" style="color: blue;">'.$descricao_pai.'</td>';    

                        foreach ($array_peso as $value) { 
                            if ($value>0 && $value!=9999) {
                                echo '<td width="2.5%" style="color: blue; text-align: right;">'.$value.'</td>';
                            }
                            else {
                        ...
                        if ($ganho==0) {
                            ...
                            echo '<td width="4%" style="color: red;"></td>'; 
                        }
                        else {
                            echo '<td width="3%" style="color: blue; text-align: right;">'.$ganho.'</td>'; 
                            echo '<td width="4%" style="color: blue; text-align: right;">'.$gmd_edi.'</td>'; 
                        }
                    }
                    else {
                        echo '<td width="7%" style="color: red;">'.$codigo_edi.'</td>';
                        echo '<td>'.$animal_descarte.'</td>';
                        echo '<td width="26%" style="color: red;">'.$desc_local.'</td>';    
                        ...
                        if ($ganho==0) {
                            ...
                            echo '<td width="4%" style="color: red; text-align: right;">'.$gmd_edi.'</td>'; 
                        }
                    }
                }
                else {
                    ...
                    echo '<td>'.$animal_descarte.'</td>';
                    echo '<td width="26%">'.$desc_local.'</td>';    
                    ...
                    if ($ganho==0) {
                        ...
                        echo '<td width="4%" style="text-align: right;">'.$gmd_edi.'</td>'; 
                    }
                }
                echo '</tr>';
                                        ...
                                        <div id="dados" class="tab-pane active">
                                           <!-- <div class="container"id="dados_cliente">-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <label class="label_consulta_rel_rel"></label>
...
<table id="tabela_gmd" class="table table-striped table-advance table-hover" width="100%" style="font-size: 9px;">
            ...
            if ($filtro_negativas=='S' && $filtro_positivas=='S') {
                if ($filtro_vacas_paridas=='N' && $filtro_vacas_solteiras=='N' && 
                    ...
                    if ($animal['filtroNumPartos']=='S' && 
                        ...
                        $dados = listar($conector, $animal, $array_mes_ano, $array_peso, $data_inicial, $data_final, $qtd_meses, $array_mes, $array_ano, $ano_mes, $gmd_total, $numero_gmd, $dados_pesos_do_animal, $animais_listados); 
...
<thead>
    ...
    <tr>
        ...
        <th colspan="3">Legenda:&nbsp;<i class="fa fa-square" style="color: blue"></i> &nbsp;Vendidos &nbsp;<i class="fa fa-square" style="color: red"></i> &nbsp;Morte/Outras Saídas</th>
        <th colspan="<?php echo ($qtd_span - 3)?>"></th>
            ...
            <div class="modal fade" id="mensagem_retorno" tabindex="-1" role="dialog" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <button data-dismiss="modal" class="btn btn-default" type="button" onclick="voltar_filtro_gmd();">Fechar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="mensagem_erro" tabindex="-1" role="dialog" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body"></div>
                        <div class="modal-footer">
                            <button data-dismiss="modal" class="btn btn-default" type="button" onclick="voltar_filtro_gmd()">Fechar
                            </button>
                        </div>
                    </div>
                </div>
