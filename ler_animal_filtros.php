...
<?php
    ...
    while ($reg_animal = mysqli_fetch_object($tbl_animais)) {
        ...
        if ($filtro_descarte=='S' && $reg_animal->tbl_animal_descarte_reproducao) {
            ...
            $dados_descarte[$reg_animal->tbl_animal_codigo_id] = 'N';
        }
    }
    ...
    if ($animais_listados>0) {
        ...
        if ($animal['numNatimortos']>=$num_natimorto_de && $animal['numNatimortos']<=$num_natimorto_ate) {
            $tem_natimorto='S';
        }
        ...
        $valor[31] = $tem_prenha;
        $valor[32] = $tem_natimorto;
        $valor[33] = $data_ultimo_peso;
