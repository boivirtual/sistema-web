                                    ...
                                    <div class="tab-pane active">
                                        <fieldset class="scheduler-border " >
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <label class="radio-inline tipo_rel">
                                                          <input type="radio" name="tipo_rel" value="I"<?php //if ($tipo_rel == 'S'){echo "checked";}?>> Geral
                                                        </label>
                                                        <label class="radio-inline tipo_rel">
                                                          <input type="radio" name="tipo_rel" value="C" checked
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-primary pull-right" data-toggle='tooltip' data-placement='top' title="Listar na Tela" onclick="listar_gmd(1)">Listar
                                                    </button>
                                                </div>

                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-success pull-right" onclick="listar_gmd(2)">Excel
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane active">
                                        ...
                                        <div class="row">  
                                            <div class="form-group col-xs-12 col-md-12">
                                                <button type="button" class="btn btn-primary" onclick="listar_gmd(4)">Aplicar Filtros</button>

                                                <button type="button" class="btn btn-info pull-right " onclick="limpar_filtros_gmd()">Limpar Filtros</button>
                                            </div>
                                        </div>

                                        <div class="row filtro_codigo_animal">
                                            <div class="col-xs-6 col-md-3">
                                                <label for="codigo_numerico_filtro" class="control-label">Código do Animal</label>
