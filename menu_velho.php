                    ...
                    <div class="dashboard-cards">
                            ...
                            <div class="col-xs-12 col-sm-5 col-md-5 animais">
                                <div class="card card-title" style="height:335;">
                                    ...
                                    <div class="col-md-12" style="max-height: 200px; overflow-y: auto;">
                                        <table class="table table-advance table-hover fontes" id="tabela_mapa">
                                            <thead>
                                                <tr>
                                                </tr>
                                            </thead>
                                    ...
                                    <!--<div id="mapa_gado" style="width: 435px; height: 300px;"></div>-->
                            ...
                            <div class="col-xs-12 col-sm-7 col-md-7 categorias">
                                <div class="card card-title blue-grey darken-1" style="color: white;">
                                    ...
                                    <div class="row" style="margin: 0; padding: 0;">
                                        ...
                                        <div class="col-md-7">
                                            <label class="fontes" style="color: white;">Fazendas:
                                            </label>
                                        ...
                                        <div class="col-md-5">
                                            <h3 id="qtd_animais" style="float: right; font-weight: 600; font-size: 2em; margin: 0; padding: 0; margin-right: 15px; color: white;">
                                            </h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 card-content">
                                            ...
                                            <table class="table table-advance fontes" id="tabela_categorias" width="100%">
                                                <thead>
                                                </thead>
                                                <tbody>
                                                </tbody>
                        ...
                        <div class="row margem_row" style="margin-bottom: 0;">
                                ...
                                <div class="card card-title blue-grey darken-1" style="color: white;">
                                    ...
                                    <div class="row" style="padding-bottom: 45px;">
                                        <form method="POST" action="#" enctype="multipart/form-data" id="form_volume_chuva">
                                            <div class="col-md-12">
                                                <table class="table contas fontes" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th></th>
                                                            <th></th>
                                            ...
                                            <table class="table contas fontes" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="color: #404245; text-align: center;">Dias Chuva</th>
                                                        <th style="color: #404245; text-align: center;">mm Mês</th>
                                                        <th style="color: #404245; text-align: center;">mm Ano</th>
                                                        <th>&nbsp;</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="dias_chuva" style="text-align: center;"></td>
                                                        <td class="mm_mes" style="text-align: center;"></td>
                                                        <td class="mm_ano" style="text-align: center;"></td>
                                                        <td><a href="#" style="color: white; font-size: 1.2em; text-align: right;" onclick="listar_chuvas_dashboad()"><i class="far fa-file-alt"></i> Relatório</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-7">
                                <div class="card card-title" style="color: white; background-color: #799499;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 card-content" style="overflow-x: auto;">
                                            ...
                                            <table class="table table-advance fontes" id="tabela_reproducao">
                                                <thead>
                                                    <tr>
                                                        <th></th>
                                                    </tr>
