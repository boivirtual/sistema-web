...
<head>
  ...
  <style type="text/css">
        #tabela_nutricao th:nth-child(1),
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
	        ...
	        <div class="row">
		        <div class="col-lg-12">
                                ...
                                <div class="tab-pane active">
                                    <fieldset class="scheduler-border" id="dados_consulta">
                                        ...
                                        <div class="row primeiro_filtro">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input name="data_final" type="date" class="form-control" id="data_final"
                                                    <?php echo "value='".$data_final."'";?> onchange='validar_data_final_consulta_nutricao()'>
                                            </div>

                                            <div class="form-group col-md-2 primeiro_filtro">
                                                <label for="descricao_lote" class="control-label"><span style="font-size: 10px">e ou</span>&nbsp;&nbsp;Lote(s)</label>
                                        ...
                                        <div class="row segundo_filtro" hidden>
                                            ...
                                            <div class="col-md-2">
                                                <a href="#" style="font-size: 0.9em; font-weight: 500; text-align: right; color: #128cb8; float: right;" onclick="relatorio_consumo_nutricao()" data-toggle='tooltip' data-placement='top' title="Verificar aqui o que escrever"><i class="fa fa-plus"></i> Relatórios</a>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                    ...
                    <div>
                        ...
                        <input name="quantidade" type="hidden" id="quantidade">
                        <input name="qtd_animais" type="hidden" id="qtd_animais">
                        <input name="ultima_nutricao" type="hidden" id="ultima_nutricao">
                        <input name="dias_nutricao" type="hidden" id="dias_nutricao">
                    </div>
                    <div id="lista_nutricao"></div>
                </div>
            </div>
            ...
            <div class="modal fade" id="excluir_nutricao" tabindex="-1" role="dialog" 
                aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Excluir Nutrição</h4>
                        </div>
                        <div class="modal-body">
                            <div class="form-group col-md-12">
                                <p><img src='img/exclamacao.png' class="fa fa-exclamation-triangle" width='20' height='23'/>&nbsp; ATENÇÃO!</p>
                                <p class="desc_modal" style="font-weight: bold;">Ao confirmar enviar esse registro para lixeira, não será possível recupera-lo pelo sistema.
                                </p>
                            </div>

                            <div class="form-group col-md-12">
                                <p><span class="label_weight">Produto:&nbsp;</span><span class="desc_produto"></span>&nbsp;&nbsp;
                                      <span class="label_weight">Última Nutrição:&nbsp;</span><span class="desc_ultima"></span></p>
                            </div>

                            <div class="form-group col-md-12">
                                <p><span class="label_weight">Pasto:&nbsp;</span><span class="desc_pasto"></span>&nbsp;&nbsp;
                                <span class="label_weight">Lote:&nbsp;</span><span class="desc_lote"></span></p>
                            </div>
                        </div>

                        <div class="modal-footer">
                            <button type="button" class="btn btn-success pull-left" onClick="gravar_nutricao()">Confirmar</button>

                            <button type="button" class="btn btn-default pull-right" data-dismiss="modal" onclick="sair_inclusao()">Voltar</button>
                        </div>
                    </div>
                </div>
            </div>

            <div class="modal fade" id="encerrar_nutricao" tabindex="-1" role="dialog" 
                aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Encerrar Nutrição</h4>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <p><span class="label_weight">Produto:&nbsp;</span><span class="desc_produto"></span>&nbsp;&nbsp;
                                      <span class="label_weight">Última Distribuição:&nbsp;</span><span class="desc_ultima"></span></p>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="data_encerramento" class="control-label"><span class="required">*</span> Data do Encerramento</label>
                                    <input name="data_encerramento" type="date" class="form-control" id="data_encerramento">
                                </div>

                                <div class="form-group col-md-8 text-primary">
                                    <label class="control-label">&nbsp;</label>
                                    <p class="dias_encerramento">12 dia(s) da Última Nutrição</p>
                                </div>
            ...
            <div class="modal fade" id="mensagem_retorno" tabindex="-1" role="dialog" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button data-dismiss="modal" class="btn btn-default" type="button" onclick="consultar_segundo_filtro()">Fechar</button>
                        </div>
                    </div>
                </div>
            </div>
