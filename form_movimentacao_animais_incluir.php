                                   ...
                                   <div class="tab-pane active table-responsive">
                                        <fieldset class="scheduler-border" id="dados_consulta">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-1">
                                                    <button type="button" class="btn btn-info pull-right" data-toggle='tooltip' data-placement='top' title='Volta para seleção de filtros' onclick="voltar_movimentacao_selecionar_digitados();">Voltar</button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5" style="font-size: 14px">
                                                    ...
                                                    <input name="idMovimentacaoGravada" type="hidden" id="idMovimentacaoGravada" value="0">
                                            ...
                                            <div class="row">  
                                                ...
                                                <div class="col-md-3">
                                                    <button type="button" class="form-control btn btn-success" onclick="reseta_confirma(); finalizar_selecao_venda_transferencia();">Finalizar  Movimentação</button>
                                                </div>
            ...
            <div class="modal fade" id="mensagem_sair_sem_confirmar" tabindex="-1" role="dialog" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button data-dismiss="modal" class="btn btn-success" type="button" onclick="confirmaSairSemGravarMovimentacao()">Confirmar
                            </button>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#id_animal").click(function(){
                ...
                $("#id_animal").val('');
                document.getElementById("id_animal").style.borderColor = "";
                return;
            });
            ...
            $("#id_animal_morte").click(function(){
                ...
                $(".alert_erro_animal span").html('');
                $(".alert_erro_animal").hide();
                document.getElementById("id_animal_morte").style.borderColor = "";
                return;
            });
            ...
            $("#id_animal_outra").click(function(){
                ...
                $(".alert_erro_animal span").html('');
                $(".alert_erro_animal").hide();
                document.getElementById("id_animal_outra").style.borderColor = "";
                return;
            });
