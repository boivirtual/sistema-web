...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Procedimentos Sanitários</h3>
                </div>
            </div>
                    ...
                    <div  class="form-group">
		       		...
		       		<section class="panel">
                        <table class="table table-striped table-advance table-hover table-bordered" 
                          id="tabela_procedimento_sanitario">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_procedimento_sanitario"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_procedimento_sanitario;
                                    $descricao = $registro_tabela->tab_descricao_procedimento_sanitario; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_procedimento_sanitario; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Procedimento Sanitário - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_procedimento_sanitario.php" enctype="multipart/form-data" id="gravar_procedimento">
                                <div class="form-group col-md-12">
                                    <label for="codigo_procedimento_sanitario" class="control-label"></label>
                                    <input name="codigo_procedimento_sanitario" type="hidden" class="form-control" id="codigo_procedimento_sanitario" 
                                    >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_procedimento_sanitario" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_procedimento_sanitario" type="text" class="form-control" id="descricao_procedimento_sanitario" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Procedimento Sanitário - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_procedimento_sanitario.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_procedimento_sanitario" class="control-label">Código</label>
                                    <input name="codigo_procedimento_sanitario" type="text" class="form-control" id="codigo_procedimento_sanitario" 
                                    readonly="">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Procedimento Sanitário - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_procedimento_sanitario.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_procedimento_sanitario" class="control-label">Código</label>
                                    <input name="codigo_procedimento_sanitario" type="text" class="form-control" id="codigo_procedimento_sanitario" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_procedimento_sanitario" class="control-label">Descrição</label>
                                    <input name="descricao_procedimento_sanitario" type="text" class="form-control" id="descricao_procedimento_sanitario" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Procedimento Sanitário </h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_procedimento_sanitario.js';
  require 'rodape.php';
?>
