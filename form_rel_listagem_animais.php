                                    ...
                                    <div class="tab-pane active">
                                        <fieldset class="scheduler-border " >
                                            ...
                                            <div class="row ">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <label class="radio-inline"> 
                                                      ...
                                                      <?php //if ($tipo_data == 'V'){echo "checked";}?>> Completa 
                                                    </label>
                                                    <label class="radio-inline">
                                                      <input type="radio" name="tipo_rel" value="R"
                                                       <?php //if ($tipo_data == 'E'){echo "checked";}?>> Resumida
                                                    </label>
                                                </div>  
                                            </div>  
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-primary pull-right" onclick="listar_animais()">Listar
                                                    </button>
                                                </div>
                                    ...
                                    <div class="tab-pane active">
                                        <div class="row">  
                                            <div class="form-group col-xs-12 col-md-12">
                                                <button type="button" class="btn btn-primary" onclick="listar_animais()">Aplicar Filtros</button>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-3 ativo">
                                                ...
                                                <label class="radio-inline">
                                                  <input type="radio" id="sim_filtro" name="ativo_filtro" value="S" <?php if ($ativo_filtro=='S'){echo 'checked="checked"';}?>>Sim
                                                </label>
                                                <label class="radio-inline">
                                                  <input type="radio" id="nao_filtro" name="ativo_filtro" value="N" <?php if ($ativo_filtro=='N'){echo 'checked="checked"';}?>>Não
                                                </label>
                                            </div>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="form-group col-xs-4 col-md-4">
                                                ...
                                                <select class="form-control selectpicker" multiple data-live-search="true" id="codigo_raca_filtro" name="codigo_raca_filtro">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-4">
                                                ...
                                                <input name="peso_inicial_nasc_filtro" type="text" class="form-control" id="peso_inicial_nasc_filtro" placeholder="0.000" onkeypress="digita_valor()" onblur="peso_inicial_nasc_filtro()" 
                                                <?php echo "value='".$peso_inicial_nasc_filtro."'";?>>
                                            </div>

                                            <div class="form-group col-xs-6 col-md-4">
                                                <label for="peso_final_nasc_filtro" class="control-label">Peso Nascimento Fim</label>
                                                <input name="peso_final_nasc_filtro" type="text" class="form-control" id="peso_final_nasc_filtro" placeholder="0.000" onkeypress="digita_valor()" onblur="peso_final_nasc_filtro()" 
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-4">
                                                ...
                                                <input name="peso_inicial_desmama_filtro" type="text" class="form-control" id="peso_inicial_desmama_filtro" placeholder="0.000" onkeypress="digita_valor()" onblur="peso_inicial_desmama_filtro()" 
                                                <?php echo "value='".$peso_inicial_desmama_filtro."'";?>>
                                            </div>

                                            <div class="form-group col-xs-6 col-md-4">
                                                <label for="peso_final_desmama_filtro" class="control-label">Peso Desmama Fim</label>
                                                <input name="peso_final_desmama_filtro" type="text" class="form-control" id="peso_final_desmama_filtro" placeholder="0.000" onkeypress="digita_valor()" onblur="peso_final_desmama_filtro()" 
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xs-6 col-md-4">
                                                ...
                                                <input name="peso_inicial_ultimo_filtro" type="text" class="form-control" id="peso_inicial_ultimo_filtro" placeholder="0.000" onkeypress="digita_valor()" onblur="peso_inicial_ultimo_filtro()" 
                                                <?php echo "value='".$peso_inicial_ultimo_filtro."'";?>>
                                            </div>

                                            <div class="form-group col-xs-6 col-md-4">
                                                <label for="peso_final_ultimo_filtro" class="control-label">Últmo Peso Fim</label>
                                                <input name="peso_final_ultimo_filtro" type="text" class="form-control" id="peso_final_ultimo_filtro" placeholder="0.000" onkeypress="digita_valor()" onblur="peso_final_ultimo_filtro()" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Relatório Listagem de Animais - Erro</h4>
                        </div>
