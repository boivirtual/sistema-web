...
<?php  
    ...
    if ($num_rows_pesagem!=0) {
        ...
        echo '<table class="table-hover" style="font-size: 12px; width:100%;"';
            echo '<tbody>';
                    ...
                    foreach ($array_locais_usuario as $value) {
                        ...
                        if ($value==$codigo_local) {
                            if ($tipo_registo=='OFFLINE') {
                                echo "<tr style='color:#0a5174;'>";
                                echo "<td width='12%'>".$data_pesagem_edi."</td>";
                                echo "<td class='desc_local' width='21%'>".$desc_local."</td>";
                                echo "<td width='21%'>".$descricao_epoca."</td>";
                                echo "<td width='19%'>".$lote."</td>";
                                echo "<td align='center' width='10%'>".$qtd_animais."</td>";
                                echo "<td hidden class='codigo_local'>".$codigo_local."</td>";
                                echo "<td hidden class='pesagem_id'>".$codigo."</td>";
                                echo "<td width='17%' align='right'>";    
                                echo "<div class='btn-group'>";
                            }
                            else {
                                echo "<tr>";
                                echo "<td class='status_nao' width='12%'>".$data_pesagem_edi."</td>";
                                echo "<td class='status_nao desc_local' width='21%'>".$desc_local."</td>";
                                echo "<td class='status_nao' width='21%'>".$descricao_epoca."</td>";
                                echo "<td class='status_nao' width='19%'>".$lote."</td>";
                                echo "<td class='status_nao' align='center' width='10%'>".$qtd_animais."</td>";
                                echo "<td hidden class='codigo_local'>".$codigo_local."</td>";
                                echo "<td hidden class='pesagem_id'>".$codigo."</td>";
                                echo "<td width='17%' align='right'>";    
                                echo "<div class='btn-group'>";
