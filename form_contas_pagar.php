                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <div class="btn-group" style="width: 100%; display: flex; gap: 0; border-radius: 4px; overflow: hidden;">
                                                        ...
                                                        <button type="button" class="btn btn-default" id="btnMesAno" style="flex: 1; text-align: center; height: 34px; border-left: none; border-right: none; border-radius: 0; color: #555; font-weight: 400;" onclick="abrirSeletorData()">Maio 2026</button>
