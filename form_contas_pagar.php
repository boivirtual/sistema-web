...
$tipos_documentos_baixar = mysqli_query($conector, "select tbl_tipo_doc_id, tbl_tipo_doc_descricao from tbl_tipo_documento where tbl_tipo_doc_lixeira=0");
...
<body>
    ...
    $stored_label  = $_SESSION['periodo_label_ctp'] ?? '';
