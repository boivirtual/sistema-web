...
<?php
    ...
    $modelo_rel = $_REQUEST['modelo_rel'];
                                    ...
                                    <div class="tab-content">
                                        <div id="dados" class="tab-pane active">
                                            <div class="container" id="dados_cliente">
                                                ...
                                                <input type="hidden" id="modelo_rel"
                                                    <?php echo "value='".$modelo_rel."'";?>>
...
<?php
    ...
    include_once "funcao_kg_ha_pasto.php";
...
<!--$spreadsheet->getActiveSheet()->setCellValueByColumnAndRow(2, 3, $total_animais);-->
        ...
        <th style="text-align: center;">00 a 07 meses</th>
        <th colspan="2" style="text-align: center;">08 a 12 meses</th>
        <th colspan="2" style="text-align: center;">13 a 24 meses</th>
        <th colspan="2" style="text-align: center;">25 a 36 meses</th>
        <th colspan="2" style="text-align: center;">> 36 meses</th>
