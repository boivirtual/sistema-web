...
<body>
  ...
  <?php
    ...
    $tbl_fornecedor = mysqli_query($conector, "select * from tbl_pessoa where (tbl_pessoa_classe=1 or tbl_pessoa_classe=2) and tbl_pessoa_lixeira=0"); 
    ...
    $tbl_conta_contabil = mysqli_query($conector, "select * from tbl_plano_contas where tbl_plano_contas_lixeira=0 and tbl_plano_contas_debito_credito='D' and tbl_plano_contas_nivel=3 order by tbl_plano_contas_descricao ASC"); 

    $tbl_cc = mysqli_query($conector, "select * from tbl_centro_custo where tbl_cc_lixeira=0"); 

    $tbl_conta_contabil_vivo = mysqli_query($conector, "select * from tbl_plano_contas where tbl_plano_contas_lixeira=0 and tbl_plano_contas_debito_credito='D' and tbl_plano_contas_nivel=3 order by tbl_plano_contas_descricao ASC"); 

    $tbl_conta_contabil_cabeca = mysqli_query($conector, "select * from tbl_plano_contas where tbl_plano_contas_lixeira=0 and tbl_plano_contas_debito_credito='D' and tbl_plano_contas_nivel=3 order by tbl_plano_contas_descricao ASC"); 
...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
            ...
            <span class="titulo">Compra - Incluir</span></span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-shopping-cart"></i> Compra - Incluir</h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel-group">
                        <form method="POST" action="#" enctype="multipart/form-data" id="form_gravar_compra">
                            <div class="panel"> 
                                <div class=panel-body>
                                    <ul class="nav nav-tabs m-bot15">
                                        <li class="active">
                                        <a data-toggle="tab" href="#dados">Dados da Compra</a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="tab-content">
                                        <div id="dados" class="tab-pane active">
                                            ...
                                            <fieldset class="scheduler-border tela_dados">
                                                ...
                                                <input type="hidden" name="numero_compra_id" id="numero_compra_id" value="0">
                                                ...
                                                <div class="row ">
                                                    <div class="form-group col-md-4">
                                                        <label for="data_compra" class="control-label"><span class="required">*</span> Data</label>

                                                        <input type="date" name="data_compra" id="data_compra" class="form-control input-sm" <?php echo "value='".$data_sistema."'";?>>
                                                    </div>

                                                    <div class="form-group col-md-3">
                                                        <label for="tem_movimentacao_compra" class="control-label"><span class="required">*</span> Animais já foram cadastrados?</label>

                                                        <div class="clearfix"></div>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="tem_movimentacao_compra" id="mov_sim" value="S" class="tem_movimentacao_compra">Sim
                                                        </label>

                                                        <label class="radio-inline">
                                                            <input type="radio" name="tem_movimentacao_compra" id="mov_nao" value="N" class="tem_movimentacao_compra">Mais Tarde
                                                        </label>
                                                    </div>

                                                    <div class="form-group col-md-5 lista_movimentacao_compra" hidden="">
                                                        <label for="lista_movimentacao_compra" class="control-label">Movimentação</label>
                                                        <select class="form-control input-sm" id="lista_movimentacao_compra" name="lista_movimentacao_compra">
                                                        <option value="000000000">...</option>
                                                        </select>
                                                    </div>
                                                </div>

                                                <div class="row local_comprador_compra" hidden="">
                                                    <div class="form-group col-md-4">
                                                        <label for="local_origem" class="control-label"><span class="required">*</span> Local Origem</label>

                                                        <select class="form-control input-sm" name="local_origem" id="local_origem">
                                                        <option value="000000000">...</option>
                                                        <?php while($reg_cliente = mysqli_fetch_object($tbl_fornecedor)) { ?>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="local_destino" class="control-label"><span class="required">*</span> Local Destino</label>
                                                        <select class="form-control input-sm" id="local_destino" name="local_destino">
                                                        <option value="000000000">...</option>
                                                        </select>
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <label for="tipo_compra" class="control-label"><span class="required">*</span> Tipo da Compra</label>

                                                        <div class="clearfix"></div>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="tipo_compra" id="peso_vivo" value="V" class="tipo_compra">Peso Vivo
                                                        </label>

                                                        <label class="radio-inline">
                                                            <input type="radio" name="tipo_compra" id="cabeca" value="C" class="tipo_compra">Cabeça
                                                        </label>
                                                    </div>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset class="scheduler-border tela_peso_vivo" hidden="">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <button type="button" class="btn btn-info pull-right exibe_tela_dados_compra">Voltar</button> 
                                                    </div>
                                                </div>

                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <p class="text-primary data_compra"></p>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="text-primary local_origem"></p>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <p class="text-primary local_destino"></p>
                                                    </div>
                                                </div>
                                            ...
                                            <!--    <hr align="center" class="linha_escondida">-->
                                                ...
                                                <div class="row linha_escondida">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="qtd_vivo" class="control-label"><span class="required">*</span> Nº Cabeças</label>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        onblur="exibe_peso_categoria_vivo()">
                                                    </div>

                                                    <div class="form-group col-md-2">
                                                        <label for="fator_arroba_vivo" class="control-label"><span class="required">*</span> Fator Multipicação</label>
                                                        <input type="text" name="fator_arroba_vivo" id="fator_arroba_vivo" class="form-control input-sm" aria-describedby="arrobaHelpBlock" placeholder="0,00" 
                                                        onkeypress="digita_valor()" 
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        onkeypress="digita_valor()" 
                                                        onblur="exibe_arroba_categoria_vivo()">
                                                        <small id="arrobaHelpBlock" class="form-text text-muted" style="color: #808080"></small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row linha_escondida">
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <select class="form-control input-sm" id="unidade_vivo" name="unidade_vivo">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="valor_unitario_vivo" class="control-label"><span class="required">*</span>Preço Unitário</label>
                                                        <input name="valor_unitario_vivo" type="text" class="form-control input-sm" id="valor_unitario_vivo" placeholder="0,00" onkeypress="digita_valor()" onblur="exibe_valor_unitario_vivo()">
                                                    </div>

                                                    <div class="form-group col-md-2">
                                                        <label for="total_vivo" class="control-label">Preço Total</label>
                                                        <input name="total_vivo" type="text" class="form-control input-sm" id="total_vivo" placeholder="0,00" onkeypress="digita_valor()" onblur="exibe_total_vivo()">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <button type="button" class="form-control input-sm btn btn-success pull-right incluir" onclick="salvar_item_animal_vivo_compra()">Confirma</button>
                                                        <button type="button" class="form-control input-sm btn btn-success editar" hidden="" onclick="salvar_editar_item_vivo_compra()">Confirma Edição</button> 
                                                    </div>
                                                </div>
                                                ...
                                                <table class="table table-striped table-advance table-hover tabela_itens_vivo" id="tabela_itens_vivo" width="100%" style="font-size: 13px;" hidden="">
                                                    <thead>
                                                        <tr>
                                                            <th> Categoria</th>
                                                            <th> Sexo</th>
                                                            <th style="text-align: right;"> Nº Cabeças</th>
                                            ...
                                            <!--    <hr align="center" class="linha_escondida">-->
                                                ...
                                                <div class="row linha_escondida">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="qtd_cabeca" class="control-label"><span class="required">*</span> Nº Cabeças</label>
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label for="valor_unitario_cabeca" class="control-label"><span class="required">*</span>Preço Unitário</label>
                                                        <input name="valor_unitario_cabeca" type="text" class="form-control input-sm" id="valor_unitario_cabeca" placeholder="0,00" onkeypress="digita_valor()" onblur="exibe_valor_unitario_cabeca()">
                                                    </div>

                                                    <div class="form-group col-md-2">
                                                        <label for="total_cabeca" class="control-label">Preço Total</label>
                                                        <input name="total_cabeca" type="text" class="form-control input-sm" id="total_cabeca" placeholder="0,00" onkeypress="digita_valor()" onblur="exibe_total_cabeca()">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row linha_escondida">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        <label class="control-label">&nbsp;</label>
                                                        <button type="button" class="form-control input-sm btn btn-success incluir" onclick="salvar_item_animal_cabeca_compra()">Confirma</button> 
                                                        <button type="button" class="form-control input-sm btn btn-success editar" hidden="" onclick="salvar_editar_item_cabeca_compra()">Confirma Edição</button> 
                                                    </div>
                                                </div>
                                        ...
                                        <div id="totais" class="tab-pane">
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    <button type="button" class="btn btn-primary gravar_compra" onclick="gravar_compra()">Confirmar </button>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <p class="text-primary tipo_compra"></p>
                                                </div>
        ...
        <div class="modal fade" id="mensagem_erro" tabindex="-1" role="dialog" 
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Compra - Mensagem</h4>
                    </div>
                    <div class="modal-body"></div>
                    <div class="modal-footer">
