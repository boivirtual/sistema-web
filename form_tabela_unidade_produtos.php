...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Unidade de Produtos</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_unidade_produtos"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_unidade_produtos;
                                    $descricao = $registro_tabela->tab_descricao_unidade_produtos; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_unidade_produtos; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Unidade de Produtos - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_unidade_produtos.php" enctype="multipart/form-data" id="gravar_unidade">
                                <div class="form-group col-md-12">
                                    <label for="codigo_unidade_produtos" class="control-label"><span class="required">*</span>Símbolo</label>
                                    <input name="codigo_unidade_produtos" type="text" class="form-control" id="codigo_unidade_produtos" maxlength="4" required="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_unidade_produtos" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_unidade_produtos" type="text" class="form-control" id="descricao_unidade_produtos" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Unidade de Produtos - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_unidade_produtos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_unidade_produtos" class="control-label">Símbolo</label>
                                    <input name="codigo_unidade_produtos" type="text" class="form-control" id="codigo_unidade_produtos" 
                                    readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_unidade_produtos" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_unidade_produtos" type="text" class="form-control" id="descricao_unidade_produtos" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Unidade de Produtos - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_unidade_produtos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_unidade_produtos" class="control-label">Símbolo</label>
                                    <input name="codigo_unidade_produtos" type="text" class="form-control" id="codigo_unidade_produtos" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_unidade_produtos" class="control-label">Descrição</label>
                                    <input name="descricao_unidade_produtos" type="text" class="form-control" id="descricao_unidade_produtos" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Unidade de Produtos</h4>
                        </div>
                        <div class="modal-body">
            ...
            <div class="modal fade" id="mensagem_erro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title">Unidade de Produtos - Mensagem</h4>
                        </div>
...
<?php 
  $javascript_file_name = 'tabela_unidade_produtos.js';
  require 'rodape.php';
?>
