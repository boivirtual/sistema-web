...
<body>
   ...
   @ session_start();   
    ...
    if ($_SESSION['local_chuva']!='') {
        $local_chuva = $_SESSION['local_chuva'];
    }
    else {
        $local_chuva = '000000000';
    }

    if ($_SESSION['ano_chuva']!=''){
        $ano = $_SESSION['ano_chuva'];
    }
    else {
        $ano = date("Y");
    }
                                        ...
                                        <fieldset class="scheduler-border " >
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-2" >
                                                    <label for="ano" class="control-label"><span class="required">*</span> Ano</label>                                                    
                                                    <select class="form-control" id="ano" name="ano">
                                                    <option value="2015"
                                                    <?php if ($ano == 2015) {echo"selected";}?>>2015
                                                    </option>
                                                    <option value="2016"
                                                    <?php if ($ano == 2016) {echo"selected";}?>>2016
                                                    </option>
                                                    <option value="2017"
                                                    <?php if ($ano == 2017) {echo"selected";}?>>2017
                                                    </option>
                                                    <option value="2018"
                                                    <?php if ($ano == 2018) {echo"selected";}?>>2018
                                                    </option>
                                                    <option value="2019"
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="codigo_local_filtro" class="control-label"><span class="required">*</span> Local</label>
                                                ...
                                                <div class="form-group col-md-1">
                                                    ...
                                                    <button type="button" class="form-control btn btn-primary pull-right" data-toggle='tooltip' data-placement='top' title="Listar na Tela"  onclick="listar_chuvas(1)">Listar
                                                    </button>
                                                </div>

                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-success pull-right" onClick="listar_chuvas(2)">Excel
                                                    </button>
                                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Registro Anual de Chuvas - Mensagem</h4>
                        </div>
