    ...
    if ($id_cobertura!=0) {
        ...
        if ($num_row!=0) {
            foreach ($itens_rows as $reg_item){
                ...
                if (isset($GLOBALS['sg_pai_semem'][$codigo_pai])) {
                    $descricao_pai = $GLOBALS['sg_pai_semem'][$codigo_pai];
                }
                else if (isset($GLOBALS['sg_pai_animal'][$codigo_pai])) {
                    $reg = $GLOBALS['sg_pai_animal'][$codigo_pai];
