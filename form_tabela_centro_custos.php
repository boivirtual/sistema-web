...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-street-view"></i> Centro de Custos</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tbl_centro_custo"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tbl_cc_codigo_id;
                                    $descricao = $registro_tabela->tbl_cc_descricao; 
                                    $lixeira = $registro_tabela->tbl_cc_lixeira; 
                                    ...
                                    if ($lixeira==1){
                                        ...
                                        echo '<td>
                                              ...
                                              data-whatevertipo="3">
                                              <i class="icon_refresh" data-toggle="tooltip" data-placement="top" title="Reataurar esse registro da lixeira" ></i>
                                              </a>
                                              </td>';
                                        echo '</tr>'; 
                                    }
                                        ...
                                        echo '<td>
                                              ...
                                              data-whatever="'.$codigo.'"
                                              data-whatevernome="'.$descricao.'">
                                              <i class="icon_pencil" data-toggle="tooltip" data-placement="top" title="Editar esse registro" ></i>
                                              </a>
                                              ...
                                              data-whatevernome="'.$descricao.'"
                                              data-whatevertipo="2">
                                              <i class="icon_trash_alt" data-toggle="tooltip" data-placement="top"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Centro de Custos - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_centro_custos.php" enctype="multipart/form-data" id="gravar_cc">
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Centro de Custos - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_centro_custos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_tipo" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_tipo" type="text" class="form-control" id="descricao_tipo" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true"  data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Centro de Custos- Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_centro_custos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_tipo" class="control-label">Código</label>
                                    <input name="codigo_tipo" type="text" class="form-control" id="codigo_tipo" 
                                    readonly="">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Centro de Custos</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_centro_custos.js';
  require 'rodape.php';
?>
