                                        ...
                                        <fieldset class="scheduler-border " >
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-11">
                                                    ...
                                                    <label class="radio-inline">
                                                      <input type="radio" name="tipo_rel" value="M" 
                                                       > Estoque Médio por Categoria
                                                    </label>
                                                </div>  

                                                <div class="form-group col-md-1">
                                                    <button type="button" class="form-control btn btn-info pull-right" onclick="onclick=voltar_relatorios_estoque()">Voltar
                                                    </button>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label for="codigo_local_estoque" class="control-label">Fazenda</label>
                                                    <select class="form-control selectpicker" id="codigo_local_estoque" multiple name="codigo_local_estoque">
                                                ...
                                                <div class="form-group col-md-1">
                                                    ...
                                                    <button type="button" class="form-control btn btn-primary pull-right" onclick="listar_estoque_cabeca()">Listar
                                                    </button>
                                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Relatório Estoque de Animais - Mensagem</h4>
                        </div>
