                                        ...
                                        <input id="exibe_conta" type="hidden" <?php echo "value='".$codigo_conta."'"; ?>>
                                            ...
                                            <fieldset class="scheduler-border dados_consulta">
                                                ...
                                                <div class="row filtros" hidden>
                                                    ...
                                                    <div class="col-md-2">
                                                        <a href="#" style="font-size: 0.9em; font-weight: 600; text-align: right; color: #128cb8; float: right;" onclick="mais_relatorios()" data-toggle='tooltip' data-placement='top' title="Análise de Pagamentos" class="pull-right"><i class="fa fa-plus"></i> Relatórios</a>
                                                    </div>
                                                </div> 
                                            </fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group col-md-3 pull-right">
                                                <a href="#" onclick="limpa_contas_selecionadas()">Limpar Filtros
                                                </a>
                                            </div>
                                        </div>
                                    </div>
