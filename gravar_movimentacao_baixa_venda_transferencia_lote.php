<?php 
	...
	// Esse programa mudou de nome em 08/01/2026 passou a ser apenas a venda/transferencia por lote

	// Antes era gravar_movimentacao_individual_digitada.php
	// Em 08/01/2026 passou a ser gravar_movimentacao_baixa_venda_transferencia_lote.php
