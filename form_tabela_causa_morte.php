...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Causa da Morte</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_causa_morte"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_causa_morte;
                                    $descricao = $registro_tabela->tab_descricao_causa_morte; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_causa_morte; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Causa da Morte - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_causa_morte.php" enctype="multipart/form-data" id="gravar_causa">
                                <div class="form-group col-md-12">
                                    <label for="codigo_causa_morte" class="control-label"></label>
                                    <input name="codigo_causa_morte" type="hidden" class="form-control" id="codigo_causa_morte" 
                                    >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_causa_morte" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_causa_morte" type="text" class="form-control" id="descricao_causa_morte" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Causa da Morte - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_causa_morte.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_causa_morte" class="control-label">Código</label>
                                    <input name="codigo_causa_morte" type="text" class="form-control" id="codigo_causa_morte" 
                                    readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_causa_morte" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_causa_morte" type="text" class="form-control" id="descricao_causa_morte" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Causa da Morte - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_causa_morte.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_causa_morte" class="control-label">Código</label>
                                    <input name="codigo_causa_morte" type="text" class="form-control" id="codigo_causa_morte" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_causa_morte" class="control-label">Descrição</label>
                                    <input name="descricao_causa_morte" type="text" class="form-control" id="descricao_causa_morte" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Causa da Morte</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_causa_morte.js';
  require 'rodape.php';
?>
