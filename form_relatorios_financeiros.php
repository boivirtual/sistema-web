...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
            ...
            <span class="titulo">Relatórios Financeiros</span></span>

           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fas fa-file-alt"></i> 
                    Relatórios Financeiros</h3>
                </div>
            </div>
                            ...
                            <div class="tab-panel">
                                <div class="tab-pane active">
                                    <div  class="form-group opcoes_topo">
                                        ...
                                        <a href="form_rel_analise_pagamento.php?tipo=1">
                                            <input type="button" class="btn btn-primary " aria-label="Left Align" 
                                              value="Análise de Pagamentos"/>
                                        </a>

                                        <a href="form_rel_analise_recebimento.php?tipo=1">
                                            <input type="button" class="btn btn-primary " aria-label="Left Align" 
                                        ...
                                        <a href="form_rel_compra_venda.php?tipo=1">
                                            <input type="button" class="btn btn-primary " aria-label="Left Align" 
                                              value="Compras/Vendas"/>
                                        </a>
                                    </div> 
                                </div>
                            </div>
