                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <label class="radio-inline tipo_rel">
                                                          <input type="radio" name="tipo_rel" value="G"<?php //if ($tipo_rel == 'S'){echo "checked";}?>> Geral
                                                        </label>
                                                        <label class="radio-inline tipo_rel">
                                    ...
                                    <div class="tab-pane active">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-xs-6 col-md-3">
                                                ...
                                                <?php
                                                if ($array_sexo[0]=="Todos" || $array_sexo[0]=="M") {
                                                    echo '<input type="checkbox" checked="checked" value="M" name="macho_filtro" id="macho_filtro"> Macho';
                                                }
                                                else if ($array_sexo[0]!="Todos"){
                                                    foreach ($array_sexo as $value) {
                                                        if ($value=="M") { 
                                                            ...
                                                            echo '<input type="checkbox"  value="M" name="macho_filtro" id="macho_filtro"> Macho';
                                                        }
                                                    }                       
                                                }
                                                else {
                                                ...
                                                <?php
                                                if ($array_sexo[0]=="Todos" || $array_sexo[0]=="F") {
                                                    echo '<input type="checkbox" checked="checked" value="F" name="femea_filtro" id="femea_filtro"> Fêmea';
                                                }
                                                else if ($array_sexo[0]!="Todos"){
                                                    foreach ($array_sexo as $value) {
                                                        if ($value=="F") { 
                                                            ...
                                                            echo '<input type="checkbox"  value="F" name="femea_filtro" id="femea_filtro"> Fêmea';
                                                        }
                                                    }                       
                                                }
                                                else {
            ...
            <div class="modal fade" id="mensagem_filtro_reproducao" tabindex="-1" role="dialog" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>-->
                            <h4 class="modal-title">Ganho de Peso - Mensagem</h4>
                        </div>
...
<script src="js/relatorios_gmd.js?<?php echo Versao; ?>" charset="utf-8" type="text/javascript" ></script>
