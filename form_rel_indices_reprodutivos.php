                                        ...
                                        <fieldset class="scheduler-border " >
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select class="form-control selectpicker" id="codigo_local" multiple name="codigo_local" title="...">
                                                ...
                                                <div class="form-group col-md-3 estacao_monta">
                                                    <label for="codigo_estacao_monta" class="control-label">Estação de Monta</label>
                                                    <select class="form-control selectpicker" multiple id="codigo_estacao_monta" name="codigo_estacao_monta" title="...">
                                                    </select>
                                                </div>

                                                <div class="form-group col-xs-4 col-md-2 data" hidden>
                                                    <label class="control-label">Período (de)</label>

                                                    <input name="periodo_de" type="date" class="form-control" id="periodo_de">
                                                </div>

                                                <div class="form-group col-xs-4 col-md-2 data" hidden>
                                                    <label class="control-label">Período (até)</label>
                                                    <input name="periodo_ate" type="date" class="form-control" id="periodo_ate" 
                                                    <?php //echo "value='".$periodo_ate."'";?>>
                                                </div>

                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-primary pull-right" data-toggle='tooltip' data-placement='top' title="Listar na Tela"  onclick="listar_indices(1)">Listar
                                                    </button>
                                                </div>

                                                <div class="form-group col-md-1">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-success pull-right" onClick="listar_indices(2)">Excel
                                                    </button>
                                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Relatório Índices Reprodutivos - Mensagem
                        </div>
...
<script src="js/relatorios_indice_reprodutivos.js?<?php echo Versao; ?>" charset="utf-8" type="text/javascript" ></script>
