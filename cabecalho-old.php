    ...
    <header class="header dark-bg" style="z-index: 1;">
        ...
        <a href="menu.php" class="logo">
            ...
            <img src="<?php echo $icone_empresa;?>" alt="" class="logo-img-25">
      ...
      <div class="top-nav notification-row">
        ...
        <div>
            <input type="hidden" name="array_manejo_animais" id="array_manejo_animais"
             <?php echo "value='".$array_manejo_animais."'"?>>
            <input type="hidden" name="array_manejo_reprodutivo" id="array_manejo_reprodutivo"
             <?php echo "value='".$array_manejo_reprodutivo."'"?>>
            <input type="hidden" name="array_suplemento_alimentar" id="array_suplemento_alimentar"
             <?php echo "value='".$array_suplemento_alimentar."'"?>>
            <input type="hidden" name="array_controle_sanitario" id="array_controle_sanitario"
             <?php echo "value='".$array_controle_sanitario."'"?>>
            <input type="hidden" name="array_gestao_adm" id="array_gestao_adm"
             <?php echo "value='".$array_gestao_adm."'"?>>
