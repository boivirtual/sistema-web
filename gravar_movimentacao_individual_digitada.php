    		...
    		if ($itens[13]=='') {
		        ...
		        if ($num_rows_pasto!=0) {
			        ...
			        if ($num_rows_pasto!=0) {
						...
						header('Content-type: application/json');
						echo json_encode(array('error' => true, 'message' => 'Não existe animal do sexo: ' . $sexo . ' Nascimento: ' . $data_nascimento . ' nos pastos. Código do animal verificado: '. $codigo_animal . ' - ' . $sql));
						exit;
					}
		        }
    		} // fim $itens[13]
