        ...
        <?php
            ...
            if ($num_rows!=0) {
                while ($reg_categoria = mysqli_fetch_object($tbl_categoria)) {
                    ...
                    $array_peso_medio_inicial_macho[$codigo_categoria] = 999999999;
                    $array_peso_medio_final_macho[$codigo_categoria] = 999999999;
                    ...
                    $array_peso_medio_inicial_femea[$codigo_categoria] = 999999999;
                    $array_peso_medio_final_femea[$codigo_categoria] = 999999999;
            ...
            $tbl_peso = mysqli_query($conector, "SELECT * FROM tbl_item_pesagem
                ...
                WHERE tbl_ite_pesagem_data_emissao>='$data_inicial' AND 
                      ...
                      tbl_pesagem_codigo_epoca=11 AND
            ...
            if ($num_rows_peso!=0) {
                while ($reg_peso = mysqli_fetch_object($tbl_peso)) {
                    ...
                    $sexo = $reg_peso->tbl_ite_pesagem_sexo;
                    $categoria = $reg_peso->tbl_ite_pesagem_categoria;
                    $qtd_animais = $reg_peso->tbl_ite_pesagem_qtd_animais;
                    $peso_medio = $reg_peso->tbl_ite_pesagem_peso_medio;
            ...
            if ($wcategoria=="") {
                for ($i=1; $i <= 5; $i++) { 
                    ...
                    if ($array_qtd_inicial_macho[$j]!=0) {
                        ...
                        echo '<td width="10%" style="text-align: center;">'.$array_qtd_inicial_macho[$j].'</td>';
                        echo '<td width="10%" style="text-align: center;">'.$array_peso_medio_inicial_macho[$j].'</td>';
                        echo '<td width="10%" style="text-align: center;">'.$array_qtd_final_macho[$j].'</td>';
                        echo '<td width="10%" style="text-align: center;">'.$array_peso_medio_final_macho[$j].'</td>';
                    ...
                    if ($array_qtd_inicial_femea[$j]!=0) {
                        ...
                        echo '<td width="10%" style="text-align: center;">'.$array_qtd_inicial_femea[$j].'</td>';
                        echo '<td width="10%" style="text-align: center;">'.$array_peso_medio_inicial_femea[$j].'</td>';
                        echo '<td width="10%" style="text-align: center;">'.$array_qtd_final_femea[$j].'</td>';
                        echo '<td width="10%" style="text-align: center;">'.$array_peso_medio_final_femea[$j].'</td>';
