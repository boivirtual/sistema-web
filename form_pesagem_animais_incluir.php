                                    ...
                                    <div id="dados" class="tab-pane active">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                ...
                                                <input name="codigo_number_filtro" type="text" class="form-control" id="codigo_number_filtro" autocomplete="off" onchange="ler_animal_aplicar_filtro()">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12" style="text-align: center;">
                                                ...
                                                <span id="desc_descarte" class="text-danger" style="font-size: 20px; font-weight: 400;"></span>
...
<script src="js/typeahead.js"></script>
    ...
    <script>
        // Inicialização da tabela esta aqui para não entrar em conflito com a tabela da edição sem finalizar que esta na pesagem.js
        ...
        var configDataTable = {
            ...
            dom: 't',
            columnDefs: [
                { "className": "hide_column", "targets": [8, 9] } 
            ],
            language: {
                zeroRecords: "Nenhum animal inserido"
            }
        };

        // 2. Inicialize quando o documento estiver pronto
        $(document).ready(function() {
            // Verifica se a tabela existe e inicializa
