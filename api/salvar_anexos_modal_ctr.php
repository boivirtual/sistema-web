<?php
/**
 * api/salvar_anexos_modal_ctr.php
 * Salva novos anexos/links para uma parcela de contas a receber via modal_anexos_ctr.
 *
 * POST params:
 *   ctr_id              — id da parcela em contas_receber
...
if (!empty($_FILES['anexo']['name'][0])) {
    $pasta = dirname(__DIR__) . '/uploads/ctr/';
