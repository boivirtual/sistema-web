...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
            ...
            <span class="titulo">Pelagens de Animais</span></span>

           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Pelagens de Animais</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_pelagens"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_pelagem;
                                    $descricao = $registro_tabela->tab_descricao_pelagem; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_pelagem; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Pelagens de Animais - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_pelagens.php" enctype="multipart/form-data" 
                            id="gravar_pelagem">
                                <div class="form-group col-md-12">
                                    <label for="codigo_pelagem" class="control-label"></label>
                                    <input name="codigo_pelagem" type="hidden" class="form-control" id="codigo_pelagem" 
                                    >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_pelagem" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_pelagem" type="text" class="form-control" id="descricao_pelagem" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Pelagens de Animais - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_pelagens.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_pelagem" class="control-label">Código</label>
                                    <input name="codigo_pelagem" type="text" class="form-control" id="codigo_pelagem" 
                                    readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_pelagem" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_pelagem" type="text" class="form-control" id="descricao_pelagem" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Pelagens de Animais - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_pelagens.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_pelagem" class="control-label">Código</label>
                                    <input name="codigo_pelagem" type="text" class="form-control" id="codigo_pelagem" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_pelagem" class="control-label">Descrição</label>
                                    <input name="descricao_pelagem" type="text" class="form-control" id="descricao_pelagem" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Pelagens</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_pelagens.js';
  require 'rodape.php';
?>
