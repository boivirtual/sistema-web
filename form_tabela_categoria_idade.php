		                ...
		                <tbody>
                            <?php 
                                ...
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_categoria_idade;
                                    $categoria_de = $registro_tabela->tab_categoria_idade_de; 
                                    $categoria_ate = $registro_tabela->tab_categoria_idade_ate; 

                                    if ($categoria_ate==999999999) {
                                      $descricao = '> 36 meses';
                                    }
                                    else {
                                      $descricao = $categoria_de . ' a ' . $categoria_ate . ' meses';
                                    }
                                    $lixeira = $registro_tabela->tab_registro_lixeira_categoria_idade; 
                                    ...
                                    if ($lixeira==1){
                                        ...
                                        echo '<td>
                                              ...
                                              data-whatevercat_de="'.$categoria_de.'"
                                              data-whatevercat_ate="'.$categoria_ate.'"
                                              data-whatevertipo="3">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Categoria - Incluir</h4>
                        </div>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="gravar_categoria_idade.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="categoria_de" class="control-label"><span class="required">*</span>Categoria de (Meses)</label>
                                    <input name="categoria_de" type="number" class="form-control" id="categoria_de" required="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="categoria_ate" class="control-label"><span class="required">*</span>Categoria até (Meses) </label>
                                    <input name="categoria_ate" type="number" class="form-control" id="categoria_ate" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Categoria - Editar</h4>
                        </div>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="gravar_categoria_idade.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="categoria_de" class="control-label"><span class="required">*</span>Categoria de (Meses)</label>
                                    <input name="categoria_de" type="number" class="form-control" id="categoria_de" required="" onkeyup="destrava_alteracao()">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="categoria_ate" class="control-label"><span class="required">*</span>Categoria até (Meses)</label>
                                    <input name="categoria_ate" type="number" class="form-control" id="categoria_ate" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Categoria - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_categoria_idade.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_categoria" class="control-label">Código:</label>
                                    <input name="codigo_categoria" type="text" class="form-control" id="codigo_categoria" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="categoria_de" class="control-label">Categoria de (Meses)</label>
                                    <input name="categoria_de" type="text" class="form-control" id="categoria_de" readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="categoria_ate" class="control-label">Categoria até (Meses)</label>
                                    <input name="categoria_ate" type="number" class="form-control" id="categoria_ate" readonly="">
                                </div>
...
<?php 
  $javascript_file_name = 'tabela_categoria_idade.js';
  require 'rodape.php';
?>
