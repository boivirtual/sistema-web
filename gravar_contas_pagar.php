...
ob_start(function($buffer) {
	...
	if ($tipo_operacao==2) {
		...
		// Valor, qtd de parcelas, doc e fornecedor atuais (antes do UPDATE), para
		// decidir se o rateio precisa ser recalculado e, se for conta parcelada,
		// achar as parcelas-irmãs pela identidade que o registro tinha até agora
		$ctp_id_esc = (int) $ctp_id;
		$rs_atual   = mysqli_query($conector, "SELECT ctp_valor_parcela, ctp_qtd_parcelas, ctp_numero_doc, ctp_codigo_fornecedor FROM contas_pagar WHERE ctp_id='$ctp_id_esc'");
