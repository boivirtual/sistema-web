...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
            ...
            <span class="titulo">Módulo Pasto</span></span>

           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Módulo Pasto</h3>
                </div>
            </div>
		        ...
		        <div class="col-lg-12">
                    ...
                    <div  class="form-group">
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                $ssql = "select * from tbl_modulo_pasto"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tbl_modulo_id;
                                    $descricao = $registro_tabela->tbl_modulo_descricao; 
                                    $lixeira = $registro_tabela->tbl_modulo_lixeira; 
                                    ...
                                    if ($lixeira==1){
                                        ...
                                        if ($codigo!=999 && $codigo!=1006 && $codigo!=1007) {
                                            echo '<td>
                                                  <a class="btn" href="#" 
                                                  data-toggle="modal" 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Módulo Pasto - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_modulo_pasto.php" enctype="multipart/form-data" id="gravar_modulo">
                                <div class="form-group col-md-12">
                                    <label for="codigo_modulo" class="control-label"></label>
                                    <input name="codigo_modulo" type="hidden" class="form-control" id="codigo_modulo" 
                                    >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_modulo" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_modulo" type="text" class="form-control" id="descricao_modulo" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Módulo Pasto - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_modulo_pasto.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_modulo" class="control-label">Código</label>
                                    <input name="codigo_modulo" type="text" class="form-control" id="codigo_modulo" 
                                    readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_modulo" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_modulo" type="text" class="form-control" id="descricao_modulo" required="" onkeyup="destrava_alteracao()">
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Módulo Pasto - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_modulo_pasto.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_modulo" class="control-label">Código</label>
                                    <input name="codigo_modulo" type="text" class="form-control" id="codigo_modulo" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input name="descricao_modulo" type="text" class="form-control" id="descricao_modulo" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Módulo Pasto</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_modulo_pastos.js';
  require 'rodape.php';
?>
