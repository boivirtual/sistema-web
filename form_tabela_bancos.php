	        ...
	        <div class="row">
		        <div class="col-lg-12">
                    ...
                    <div  class="form-group">
                        <a href="#">
                            <input type="button" class="btn btn-primary incluir" aria-label="Left Align" 
                            data-toggle="modal" 
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tbl_banco"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo_id = $registro_tabela->tbl_banco_id;
                                    $codigo_banco = $registro_tabela->tbl_banco_codigo;
                                    $nome = $registro_tabela->tbl_banco_nome; 
                                    $lixeira = $registro_tabela->tbl_banco_lixeira; 

                                    if ($lixeira==1){
                                        echo '<tr>';
                                        echo '<td style="color:#ccc">'.$codigo_banco.'</td>';
                                        echo '<td style="color:#ccc">'.$nome.'</td>';
                                        echo '<td>
                                              <a class="btn" href="#" 
                                              data-toggle="modal" 
                                              data-target="#modal_excluir" 
                                              data-whatever="'.$codigo_id.'"
                                              data-codigo_banco="'.$codigo_banco.'"
                                              data-whatevernome="'.$nome.'"
                                              data-whatevertipo="3">
                                              <i class="icon_refresh" title="Restaurar esse registro da lixeira" ></i>
                                              </a>
                                              </td>';
                                        echo '</tr>'; 
                                    }
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Bancos - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_bancos.php" enctype="multipart/form-data" id="gravar_banco">
                                <div class="form-group col-md-12">
                                    <label for="codigo_bancos" class="control-label"><span class="required">*</span>Código</label>
                                    <input name="codigo_bancos" type="number" class="form-control" id="codigo_bancos" required="" >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="nome_bancos" class="control-label"><span class="required">*</span>Nome</label>
                                    <input name="nome_bancos" type="text" class="form-control" id="nome_bancos" required="">
                                </div>
                                ...
                                <input name="codigo_id" type="hidden" id="codigo_id">
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Bancos - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_bancos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_bancos" class="control-label">Código</label>
                                    <input name="codigo_bancos" type="text" class="form-control" id="codigo_bancos" onkeyup="destrava_alteracao()">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="nome_bancos" class="control-label"><span class="required">*</span>Nome</label>
                                    <input name="nome_bancos" type="text" class="form-control" id="nome_bancos" required="" onkeyup="destrava_alteracao()" >
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Bancos - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_bancos.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_bancos" class="control-label">Código</label>
                                    <input name="codigo_bancos" type="text" class="form-control" id="codigo_bancos" 
                                    readonly="">
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="nome_bancos" class="control-label">Nome</label>
                                    <input name="nome_bancos" type="text" class="form-control" id="nome_bancos" readonly="">
                                </div>
...
<?php 
  $javascript_file_name = 'tabela_bancos.js';
  require 'rodape.php';
?>
