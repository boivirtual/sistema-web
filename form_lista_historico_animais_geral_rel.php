            ...
            if ($filtro_negativas=='S' && $filtro_positivas=='S') {
                if ($filtro_vacas_paridas=='N' && $filtro_vacas_solteiras=='N' && 
                    ...
                    if ($animal['filtroNumPartos']=='S' && 
                        ...
                        listar($conector, $animal, $peso_nasc_edi, $peso_desmama_edi, $peso_ultimo_edi, $data_ultimo_edi);  
                    }
                }
...
function listar($conector, $animal, $peso_nasc_edi, $peso_desmama_edi, $peso_ultimo_edi, $data_ultimo_edi) {
    ...
    $observacao = ltrim($animal['observacao']); 
    ...
    if ($ativo=='N') {
        if ($situacao=='Vendido') {
            ...
            echo '<td width="6%" style="text-align: center;">'.$nascimento_edi.'</td>';
            ...
            echo '<td width="3%" style="text-align: center; color: red;">'.$descarte.'</td>';    
            echo '</tr>';
        }
        else {
