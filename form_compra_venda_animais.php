                                    ...
                                    <fieldset class="scheduler-border" id="dados_consulta">
                                        ...
                                        <div class="row digitar_filtros">    
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control selectpicker" id="codigo_local_origem" multiple name="codigo_local_origem">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control selectpicker" id="codigo_local_destino" multiple name="codigo_local_destino">
                                        ...
                                        <div class="row filtros" hidden>
                                            ...
                                            <div class="col-md-2">
                                                <a href="#" style="font-size: 0.9em; font-weight: 600; text-align: right; color: #128cb8; float: right;" onclick="mais_relatorios()" data-toggle='tooltip' data-placement='top' title="Compras/Vendas" class="pull-right"><i class="fa fa-plus"></i> Relatórios</a>
                                            </div>
                                        </div> 
                                    </fieldset> 
                                </div>
