                    ...
                    <ul class="nav pull-right top-menu">
                        <li>
                            <form method="get" action="#" style="margin-right: 10px;">
                                <input type="text" class="form-control" placeholder="O que você precisa?" name="nome_pesquisa" id="nome_pesquisa" style="margin-top: 5px; margin-right: 5px; border-radius: 100px;" oninput="ler_busca()">

                                <div class="row card card-title-busca" id="tela_busca" style="position:absolute; margin-top: 3px; padding-bottom: 3px; width: 130%; word-wrap: break-word;" hidden>
                                    <div id="lido" style="margin-right: 5px;">
                                    </div>
                                </div>
                            </form>
                        </li>
