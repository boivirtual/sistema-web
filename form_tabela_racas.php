...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Raças de Animais</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_racas"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_raca;
                                    $descricao = $registro_tabela->tab_descricao_raca; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_raca; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Raças de Animais - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_racas.php" enctype="multipart/form-data" id="gravar_raca">
                                <div class="form-group col-md-12">
                                    <label for="codigo_raca" class="control-label"></label>
                                    <input name="codigo_raca" type="hidden" class="form-control" id="codigo_raca" 
                                    >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_raca" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_raca" type="text" class="form-control" id="descricao_raca" required="">
                                </div>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Raças de Animais - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_racas.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_raca" class="control-label">Código</label>
                                    <input name="codigo_raca" type="text" class="form-control" id="codigo_raca" 
                                    readonly="" >
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descricao_raca" class="control-label"><span class="required">*</span>Descrição</label>
                                    <input name="descricao_raca" type="text" class="form-control" id="descricao_raca" required="" onkeyup="destrava_alteracao()" >
                                </div>
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true" data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Raças de Animais - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_racas.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_raca" class="control-label">Código</label>
                                    <input name="codigo_raca" type="text" class="form-control" id="codigo_raca" 
                                    readonly="">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descricao_raca" class="control-label">Descrição</label>
                                    <input name="descricao_raca" type="text" class="form-control" id="descricao_raca" readonly="">
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Raças de Animais</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_racas.js';
  require 'rodape.php';
?>
