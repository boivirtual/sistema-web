<?php 
	// Grava os pesos na edição da lista excel mas não finaliza a pesagem e nem altera os dados da tabela tbl_peso_medio_categoria quando for controle de estoque por lote

	// Não grava mais o peso no cadastro por esse programa (atualizado em 12/09/2024 para gravar o peso no cadastro pelo programa gravar_pesagem_finalizar.php)
	...
	// Agora o peso só será gravado no cadastro do animal apos FINALIZAR A PESAGEM - Botão 'FINALIZAR PESAGEM' na tela de digitaão.
	// Alteração feita em 12/09/2024 conforme o item do Trello 'AJUSTES PARA PESAGEM ON-LINE E LISTA DO EXCEL'
	...
	------------------- FIM DESSA ROTINA ALTERADA EM 12/09/2024 -------------------
    */
