                            ...
                            <div class="tab-panel">
                                <div class="tab-pane active">
                                    <fieldset class="scheduler-border" id="dados_consulta">
                                        ...
                                        <div class="row filtros_consulta" hidden>
                                            <div class="col-md-12">
                                                <a href="#" style="font-size: 0.9em; font-weight: 500; text-align: right; color: #128cb8; float: right;" onclick="mais_relatorios()" data-toggle="tooltip" data-placement="top" title="Situação Reprodutiva" class="pull-right"><i class="fa fa-plus"></i> Relatórios</a>
                                            </div>
                                        </div> 
                                    </fieldset>
