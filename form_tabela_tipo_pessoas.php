...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper" style="margin-left: 5px;">
           ...
           <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Tipo de Pessoas</h3>
                </div>
            </div>
		       		...
		       		<section class="panel">
		                ...
		                <tbody>
                            <?php 
                                ...
                                $ssql = "select * from tabela_tipo_pessoas"; 
                                $rs = mysqli_query($conector, $ssql); 
                     
                                while ($registro_tabela = mysqli_fetch_object($rs)){
                                    $codigo = $registro_tabela->tab_codigo_tipo_pessoa;
                                    $descricao = $registro_tabela->tab_descricao_tipo_pessoa; 
                                    $lixeira = $registro_tabela->tab_registro_lixeira_tipo_pessoa; 
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modal_incluirLabel">Tipo de Pessoas - Incluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_tipo_pessoas.php" enctype="multipart/form-data" id="gravar_tipo"
>
             ...
             aria-labelledby="exampleModalCenterTitle" aria-hidden="true"  data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="exampleModalLabel">Tipo de Pessoas - Editar</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="gravar_tipo_pessoas.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
             ...
             aria-labelledby="modal_excluirCenterTitle" aria-hidden="true"  data-backdrop="static">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_excluirLabel">Tipo de Pessoas - Excluir</h4>
                        </div>

                        <div class="modal-body">
                            <form method="POST" action="excluir_tipo_pessoas.php" enctype="multipart/form-data">
                                <div class="form-group col-md-12">
                                    <label for="codigo_tipo" class="control-label">Código</label>
                                    <input name="codigo_tipo" type="text" class="form-control" id="codigo_tipo" 
                                    readonly="">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Tipo de Pessoas</h4>
                        </div>
                        <div class="modal-body">
...
<?php 
  $javascript_file_name = 'tabela_tipo_pessoas.js';
  require 'rodape.php';
?>
