    ...
    <section id="container" class="">
        ...
        function gerarTabelaParcelas(n) {
            ...
            for (var i = 0; i < n; i++) {
                ...
                tr += '<td colspan="4" style="padding:0; border-top:none; background:transparent;"></td>';
                tr += '<td style="padding:4px 8px;"><small style="color:#888;">Data Pagamento</small><br>';
                ...
                tr += '<input type="text" class="form-control" name="parcela[' + i + '][valor_pago]" id="parc_vlr_pago_' + i + '" placeholder="0,00" style="height:28px;font-size:12px;padding:2px 6px;background:#f0f8e8;font-weight:600;min-width:90px;" readonly></td>';
                tr += '</tr>';
