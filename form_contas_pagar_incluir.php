        ...
        function rtAtualizarTabLocais() {
            ...
            RT.locais.forEach(function(loc, idx) {
                $tbody.append(
                    ...
                    '<td><button type="button" class="btn btn-xs" style="background:transparent;border:none;box-shadow:none;padding:2px 4px;" onclick="rtRemoverLocal(' + idx + ')"><i class="icon_trash_alt"></i></button></td>' +
                    '</tr>'
                );
            });
            // bind perc input
        ...
        function rtCarregarTabCC(locIdx) {
            ...
            (loc.ccs || []).forEach(function(cc, ci) {
                $tbody.append(
                    ...
                    '<td><button type="button" class="btn btn-xs" style="background:transparent;border:none;box-shadow:none;padding:2px 4px;" onclick="rtRemoverCC(' + locIdx + ',' + ci + ')"><i class="icon_trash_alt"></i></button></td>' +
                    '</tr>'
                );
            });
        ...
        function rtCarregarTabConta(li, ci) {
            ...
            (cc.contas || []).forEach(function(ct, ti) {
                $tbody.append(
                    ...
                    '<td><button type="button" class="btn btn-xs" style="background:transparent;border:none;box-shadow:none;padding:2px 4px;" onclick="rtRemoverConta(' + li + ',' + ci + ',' + ti + ')"><i class="icon_trash_alt"></i></button></td>' +
                    '</tr>'
                );
            });
