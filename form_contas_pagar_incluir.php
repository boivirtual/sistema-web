    ...
    <section id="container" class="">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="bloco_avista" class="col-md-9" style="padding: 0;">
                                            ...
                                            <div id="bloco_pago_avista" style="display:none; margin-top:6px; margin-left:15px; background:#fffde7; border:1px solid #ffe082; border-radius:4px; padding:6px 10px;">
                                                <div class="row" style="margin:0;">
                                                    <div class="form-group col-md-3">
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input type="text" class="form-control" id="pago_desconto" name="pago_desconto" placeholder="0,00"
                                                               onkeypress="$(this).off('keypress.m').on('keypress.m',mask.money)" onblur="calcularValorPagoAvista()">
                                                    </div>
                                                    <div class="form-group col-md-2">
        ...
        function gerarTabelaParcelas(n) {
            ...
            for (var i = 0; i < n; i++) {
                ...
                tr += '<input type="text" class="form-control" name="parcela[' + i + '][desconto]" id="parc_desconto_' + i + '" placeholder="0,00" style="height:28px;font-size:12px;padding:2px 6px;" onkeypress="$(this).off(\'keypress.m\').on(\'keypress.m\',mask.money)" onblur="recalcularValorPago(' + i + ')"></td>';
                tr += '<td style="padding:4px 8px;"><small style="color:#888;">Juros</small><br>';
                tr += '<input type="text" class="form-control" name="parcela[' + i + '][juros]" id="parc_juros_' + i + '" placeholder="0,00" style="height:28px;font-size:12px;padding:2px 6px;" onkeypress="$(this).off(\'keypress.m\').on(\'keypress.m\',mask.money)" onblur="recalcularValorPago(' + i + ')"></td>';
