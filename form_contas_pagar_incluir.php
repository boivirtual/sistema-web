    ...
    <section id="container" class="">
        ...
        function gerarTabelaParcelas(n) {
            ...
            for (var i = 0; i < n; i++) {
                ...
                tr += '<input type="text" class="form-control" name="parcela[' + i + '][desconto]" id="parc_desconto_' + i + '" placeholder="0,00" style="height:28px;font-size:12px;padding:2px 6px;" onkeypress="mask.money.call(this, event)" onblur="recalcularValorPago(' + i + ')"></td>';
                tr += '<td style="padding:4px 8px;"><small style="color:#888;">Juros</small><br>';
                tr += '<input type="text" class="form-control" name="parcela[' + i + '][juros]" id="parc_juros_' + i + '" placeholder="0,00" style="height:28px;font-size:12px;padding:2px 6px;" onkeypress="mask.money.call(this, event)" onblur="recalcularValorPago(' + i + ')"></td>';
