                                    ...
                                    <div class="tab-pane active">
                                        <fieldset class="scheduler-border " >
                                            ...
                                            <div class="row filtro_relatorio">
                                                ...
                                                <div class="">
                                                    <label for="tipo_rel" class="control-label">&nbsp;</label>
                                                </div>
                                            ...
                                            <!--    <div class="col-md-2">
                                                    <label class="control-label">&nbsp;</label>
                                                    <button type="button" class="form-control btn btn-info pull-right" onclick="consultar_filtro_relatorio()">Consultar</button>
                                                </div>-->
