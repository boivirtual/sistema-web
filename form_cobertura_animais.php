                                    ...
                                    <fieldset class="scheduler-border" id="dados_consulta">  
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <a href="#" style="font-size: 0.9em; font-weight: 500; text-align: right; color: #128cb8; float: right;" onclick="agenda_protocolo()"  class="pull-right"><i class="far fa-calendar-alt"></i>&nbsp;Agenda de Protocolos</a>
                ...
                <div class="modal-dialog modal-xxl modal-dialog-centered modal-direita" role="document" style="width: 100%;">
                    <div class="modal-content">
                        <div class="modal-header" style="padding-bottom: 12px">
                            ...
                            <button class="btn btn-success pull-right" type="button" style="margin-right: 6px;" onclick="gerar_lista_excel();">Excel</button>
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-success" type="button" onclick="gerar_lista_excel();">Excel</button>
