...
<body>
    ...
    if ($_SESSION['tipo_rel_ctp'] == '') {
        $tipo_rel = "A";
    } else {
        $tipo_rel =  $_SESSION['tipo_rel_ctp'];
    }
                    ...
                    <div class="col-lg-12">
                        <div class="row col-md-12 filtro_exibido" id="consulta_contas">
                            <form method="GET" action="#" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="tipo_conta" id="tipo_conta" value="D">
                                        ...
                                        <fieldset class="scheduler-border ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-1">
                                                    <button type="button" class="form-control btn btn-info pull-right" onclick="onclick=voltar_relatorios_pagar()">Voltar
                                                    </button>
                                                </div>
                                            </div>
        ...
        if ($value == $reg_local->tbl_pessoa_id) {
            echo '<option value="' . $value . '">' . $reg_local->tbl_pessoa_nome . '</option>';
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select class="form-control selectpicker" id="codigo_fornecedor" name="codigo_fornecedor" data-live-search="true" multiple style="z-index:5;" data-size="6">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="tipo_rel" value="A" <?php if ($tipo_rel == 'A') {
                                                            echo "checked";
                                                            } ?>> Analítico
                                                    </label>

                                                    <label class="radio-inline">
                                                        <input type="radio" name="tipo_rel" value="S" <?php if ($tipo_rel == 'S') {
                                                            echo "checked";
                                                            } ?>> Sintético
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-group col-md-1">
                                                    <button type="button" class="btn btn-primary pull-right" data-toggle='tooltip' data-placement='top' title="Listar na Tela" onclick="listar_contas_pagar_tela(1)">Listar
                                                    </button>
                                                </div>

                                                <div class="form-group col-md-1">
                                                    <button type="button" class="form-control btn btn-success pull-right" onClick="listar_contas_pagar_tela(2)">Excel
                                                    </button>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group col-md-3 pull-right">
                                            <a href="#" onclick="limpa_contas_selecionadas_ctp()">Limpar Filtros
                                            </a>
                                        </div>
                                    </div>
                                </div>
