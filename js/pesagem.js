...
function ler_animal() {
    var id_animal = parseInt($("#codigo_id").val());

    $("#tabela_itens tbody tr").each(function () {
        var id_lista = parseInt($(this).find(".codigo_id").html());
...
function ler_animal_editar_apos_time() {
   ...
   //var id_animal = $("#id_animal").val();
    ...
    $("#tabela_itens tbody tr").each(function () {
        var id_lista = parseInt($(this).find(".id_animal").html());
...
function Salvar_editar() {
    ...
    $("#tabela_itens tbody tr").each(function () {
        ...
        if (row_index_salvar == row_index) {
            $(this).find(".id_animal").html($("#codigo_number_filtro").val());
...
function gravar_pesagem() {
    ...
    $("#tabela_itens tbody tr").each(function () {
        ...
        var observacao = $(this).find(".observacao").html();
        var codigo_id = $(this).find(".codigo_id").html();    
        var stringLimpa = codigo_id.replace(/\D/g, '');
        var codigo_id = parseInt(stringLimpa, 10);
