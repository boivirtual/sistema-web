...
function modal_grupo_estacao() {
    ...
    $.post("form_lista_grupos_estacao.php", {local:local, id_parametro_estacao:id_parametro_estacao, flag:1},
        function(valor){ 
...
function ler_animal(){
    ...
    $.post("ler_animal_selecao_matriz.php", {
        ...
        if (php[0]=='Nao tem animal') {
            ...
            $("#alert_erro_animal .negrito").html('');
            $("#alert_erro_animal span").html('Esta Fêmea foi descartada para Reprodução.');
            $(".alert_erro_animal").show();
            $('#descricao_animal').text('');
            $('#voltar').focus();            
            $("#codigo_id").val('');
...
function ler_animal_descarte(){
    ...
    $.post("ler_animal_selecao_descarte.php", {
        ...
        if (php[0]=='Nao tem animal') {
            ...
            $("#alert_erro_animal .negrito").html('');
            $("#alert_erro_animal span").html('Esta Fêmea já está Descartada para Reprodução.');
            $(".alert_erro_animal").show();
            $('#descricao_animal').text('');
            $('#voltar').focus();            
            $("#codigo_id").val('');
