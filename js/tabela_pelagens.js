...
$(document).ready(function(){
    $('.gravar').on('click', function() {
        var formID = document.getElementById("gravar_pelagem");
...
$('#modal_editar').on('show.bs.modal', function (event) {
    ...
    modal.find('#codigo_pelagem').val(recipient)
    modal.find('#descricao_pelagem').val(recipientnome)
})
