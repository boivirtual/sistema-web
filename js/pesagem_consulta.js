    ...
    initComplete: function () {
        ...
        /*$("#container_filtro").html(`
            ...
            <a href="#" id="btn_novo_motivo"
               ...
               <i class=""></i> Cancelar criar lista com Novo Motivo
            </a>
            ...
            <div id="titulo_novo_motivo"
                 style="display:none; margin-top: 8px; font-size: 14px; font-weight: 400;">
                 SELECIONE os animais para a lista com o novo motivo
            </div>
        ...
        $("#container_filtro").html(`
            ...
            <div style="display:flex; align-items:center; flex-wrap:wrap; gap:10px;">
                ...
                <a href="#"
                   style="font-size: 0.9em; font-weight: 500; color: #128cb8; line-height: 35px;"
                   onclick="filtro_apartacao()"
                   data-toggle="tooltip"
                   title="Filtro Apartação">
                   <i class="fas fa-filter"></i> Filtro Apartação
                </a>
                ...
                <a href="#"
                   ...
                   style="font-size: 0.9em; font-weight: 500; color: #128cb8; line-height: 35px;"
                   onclick="alternarModoNovoMotivo(); return false;">
                   <i class="fa fa-window-close-o"></i> Cancelar criar lista com Novo Motivo
                </a>

                <button type="button"
                    id="btn_confirmar_novo_motivo"
            ...
            <p style="${corFrase}">
                Existem animais repetidos nessa lista ou em outra pesagem não finalizada
            </p>
        `);        
...
function atualizarVisibilidadeSelecaoMotivo() {
    ...
    if (modoNovoMotivoAtivo) {
        ...
        $('#btn_novo_motivo').html(
            '<i class="fa fa-check-square-o"></i> Criar lista com novo Motivo'
        );
    }
...
$(document).on('click', '#btn_modal_confirmar_novo_motivo', function () {
    ...
    const btnConfirmar = document.getElementById('btn_modal_confirmar_novo_motivo'); 
...
function filtro_apartacao() {
    var codigo_pesagem = $("#numero_pesagem_id").html(); // Pega o ID da pesagem atual
