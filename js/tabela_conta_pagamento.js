...
$(document).ready(function(){
    $('.gravar').on('click', function() {
        var formID = document.getElementById("gravar_conta_pagamento");
...
$('#modal_excluir').on('show.bs.modal', function (event) {
    ...
    var modal = $(this)
    if (tipo_gravacao==3){
        modal.find('.modal-title').text('Conta Pagamento - Restaurar da lixeira ')
    }
    else if (tipo_gravacao==2){
        modal.find('.modal-title').text('Conta Pagamento - Enviar para lixeira ')
    }
