...
function consultar_primeiro_filtro() {
    ...
    $.post("form_lista_nutricao_primeiro_filtro.php", {local:local, data_inicial:data_inicial, data_final:data_final },
        function(valor){ 
        ...
        $.post("lista_lotes_nutricao.php", {local:local, data_inicial:data_inicial, data_final:data_final}, function(valor){
