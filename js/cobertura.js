...
function consultar_cobertura(){
    ...
    /*if (tipo_registro == "C") {
        tipo_filtro = "Fêmeas p/ Cobertura";
    } else {
        tipo_filtro = "Descartes";
    }*/
...
//TIRAR
/*function opcao_nova_cobertura(id, value) {
    if (value == 'G') {
        $(".grupo_nova_cobertura").show();
        ...
        //let grupo = $("#grupo_id").val();
        //let codigo_animal = $(`#animal_id${ordem}`).val();
...
function gravar_diagnostico_negativo() {
    ...
    //if (opcao_diagnostico==undefined) {
      //  alert ('Informe uma opção para o diagnóstico negativo.');
        //return;
    //}
    ...
    //if (opcao_diagnostico=='N' && opcao_nova_cobertura==undefined) {
        //alert ('Informe uma opção para a nova cobertura.');
        //return;
    //}
    ...
    //if (opcao_diagnostico=='D') {
    //    opcao_nova_cobertura='';
    //    grupo = '000';
    // }
        ...
        $.ajax({
            ...
            success: function(data){
                if (data.error) {
                    ...
                    elemento.setAttribute('title', 'A alteração de Diagnóstico Negativo para Positivo só poderá ser feita na tela de Diagnóstico.');                    
                    $(elemento).tooltip();
