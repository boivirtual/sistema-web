...
function editar_animal(animal) {
    ...
    */
    ...
    lista_estacoes();
    lista_movimentacoes(animal.codigoAnimal,animal.codigoNumerico,animal.codigoAlfa);
...
function lista_movimentacoes(codigo_id, codigo_numerico, codigo_alfa){
    $.post("lista_historico_movimentacoes_animais.php", {codigo_id:codigo_id},
        function(valor){ 
